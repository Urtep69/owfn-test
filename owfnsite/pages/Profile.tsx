...
const TokenListSkeleton = () => (
    <div className="space-y-2 animate-pulse">
        <div className="grid grid-cols-3 gap-4 px-4 py-2">
             <div className="h-4 bg-primary-200 dark:bg-darkPrimary-700 rounded w-1/4"></div>
             <div className="h-4 bg-primary-200 dark:bg-darkPrimary-700 rounded w-1/4 ml-auto"></div>
             <div className="h-4 bg-primary-200 dark:bg-darkPrimary-700 rounded w-1/4 ml-auto"></div>
        </div>
        {[...Array(3)].map((_, i) => (
             <div key={i} className="grid grid-cols-3 gap-4 items-center p-4 rounded-lg">
                <div className="flex items-center space-x-4">
                    <div className="w-10 h-10 rounded-full bg-primary-200 dark:bg-darkPrimary-700"></div>
                    <div>
                        <div className="h-5 bg-primary-200 dark:bg-darkPrimary-700 rounded w-16 mb-1"></div>
                        <div className="h-4 bg-primary-200 dark:bg-darkPrimary-700 rounded w-24"></div>
                    </div>
                </div>
                <div className="space-y-1 ml-auto w-full">
                    <div className="h-5 bg-primary-200 dark:bg-darkPrimary-700 rounded w-3/4 ml-auto"></div>
                    <div className="h-4 bg-primary-200 dark:bg-darkPrimary-700 rounded w-1/2 ml-auto"></div>
                </div>
                <div className="h-5 bg-primary-200 dark:bg-darkPrimary-700 rounded w-1/2 ml-auto"></div>
            </div>
        ))}
    </div>
);
