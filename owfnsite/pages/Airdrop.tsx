...
const ConnectWalletPrompt = () => {
    ...
    return (
        <div className="text-center p-12 bg-surface border border-border rounded-lg max-w-md mx-auto">
...
const EligibilityChecker = () => {
    ...
    return (
        <div className="bg-surface border border-border p-8 rounded-lg max-w-md mx-auto text-center">
            {isChecking && (
                <>
            ...
            {!isChecking && eligibilityStatus === 'eligible' && (
                <div className="animate-fade-in-up">
                    ...
                    <h2 className="text-2xl font-bold text-secondary mb-2">{t('airdrop_congratulations')}</h2>
             ...
             {!isChecking && eligibilityStatus === 'not_eligible' && (
                <div className="animate-fade-in-up">
                    ...
                    <h2 className="text-2xl font-bold text-destructive mb-2">{t('airdrop_not_eligible')}</h2>
...
export default function Airdrop() {
    ...
    return (
        <div className="animate-fade-in-up space-y-8">
            ...
            <div className="max-w-2xl mx-auto mt-12 p-6 bg-surface border border-border rounded-lg">
