...
export default function Maintenance() {
    ...
    return (
        <div className="relative min-h-screen bg-background flex flex-col justify-center items-center text-center p-4 animate-fade-in-up">
            ...
            <div className="bg-surface border border-border p-8 sm:p-12 rounded-2xl shadow-lg max-w-2xl w-full">
                    ...
                    <div className="flex justify-center space-x-6 mt-4">
                        {socialLinks.map(link => (
                            <a
                                ...
                                className="text-text-secondary hover:text-primary transition-transform transform hover:scale-110"
