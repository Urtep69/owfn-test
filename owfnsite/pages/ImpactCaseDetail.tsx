                ...
                <div className="lg:col-span-2">
                    <div className="lg:sticky top-24 space-y-8">
                        <div className="bg-surface border border-border p-6 rounded-lg">
                            ...
                            <div className="bg-yellow-500/10 border border-yellow-500/20 text-yellow-300 p-3 rounded-md text-sm flex items-start space-x-2 mb-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <button onClick={handleDonate} disabled={solana.loading || !solana.connected || !(parseFloat(amount) > 0)} className="w-full bg-destructive text-white font-bold py-3 rounded-lg text-xl hover:bg-opacity-80 transition-opacity disabled:opacity-50">
