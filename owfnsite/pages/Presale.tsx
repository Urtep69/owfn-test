...
const LivePresaleFeed = ({ newTransaction }: { newTransaction: PresaleTransaction | null }) => {
    ...
    return (
        <div className="glassmorphism p-4 h-full flex flex-col">
            <div className="flex items-center gap-2 mb-4">
                <div className="w-2.5 h-2.5 bg-green-400 rounded-full animate-pulse"></div>
                <h3 className="text-text-primary font-bold">{t('live_presale_feed')}</h3>
            </div>
            <div className="grid grid-cols-4 gap-2 text-xs text-text-secondary pb-2 border-b border-border-color font-semibold">
...
const ProjectInfoRow = ({ label, value }: { label: string, value: React.ReactNode }) => (
  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-3 border-b border-border-color/50">
...
export default function Presale() {
  ...
  return (
        <div className="animate-fade-in-up">
            ...
            <div className="glassmorphism rounded-xl p-6 md:p-10 shadow-glow-lg">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mt-6">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="glassmorphism p-4 text-center rounded-lg">
                        ...
                        <div className="glassmorphism p-6 space-y-4">
                            ...
                            <div className="bg-surface-2 p-4 rounded-lg space-y-3">
                                ...
                                {calculation.bonusApplied && (
                                    <div className="flex justify-between items-center text-sm text-success animate-fade-in-up" style={{animationDuration: '300ms'}}>
