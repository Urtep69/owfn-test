...
const LivePresaleFeed = ({ newTransaction }: { newTransaction: PresaleTransaction | null }) => {
    ...
    return (
        <div className="bg-surface border border-border rounded-lg p-4 h-full flex flex-col">
            ...
            <div className="grid grid-cols-4 gap-2 text-xs text-text-secondary pb-2 border-b border-border font-semibold">
...
const ProjectInfoRow = ({ label, value }: { label: string, value: React.ReactNode }) => (
  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-3 border-b border-border last:border-b-0">
...
export default function Presale() {
  ...
  return (
    <div className="bg-background text-text-primary min-h-screen -m-8 p-4 md:p-8 flex justify-center font-sans">
      <div className="w-full max-w-screen-2xl">
        ...
        <div className="bg-surface rounded-xl p-6 md:p-10 border border-border">
            
            {/* Header */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <img src={OWFN_LOGO_URL} alt="Token Logo" className="w-20 h-20 rounded-full border-2 border-border"/>
            ...
            {/* Description */}
            <p className="text-text-secondary text-sm leading-relaxed mt-4">{t('about_mission_desc')}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mt-6">
                     ...
                     <div className="space-y-4">
                        <AccordionSection title={t('presale_project_info_title')} isOpen={true}>
                            <div className="space-y-1 text-sm">
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-3 border-b border-border">
                ...
                <div className="lg:col-span-2 space-y-6 flex flex-col">
                    ...
                    <div className="bg-background border border-border rounded-lg p-6 space-y-4">
                        ...
                        {solana.connected && (
                            <div className="text-center text-xs text-text-secondary p-2 bg-surface rounded-md">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full bg-surface border rounded-lg py-3 pl-11 pr-4 text-lg font-mono text-text-primary text-right focus:ring-2 focus:border-primary placeholder-text-secondary ${error ? 'border-destructive focus:ring-destructive' : 'border-border focus:ring-primary'}`}
                                placeholder="0.00"
                        ...
                        <div className="bg-surface p-4 rounded-lg space-y-3">
                            ...
                            {calculation.bonusApplied && (
                                <div className="flex justify-between items-center text-sm text-secondary animate-fade-in-up" style={{animationDuration: '300ms'}}>
                        ...
                        <button 
                            onClick={handleBuy}
                            className="w-full bg-primary text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-opacity-80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
