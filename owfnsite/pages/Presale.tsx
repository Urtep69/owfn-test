                ...
                <div className="lg:col-span-2 space-y-6 flex flex-col">
                    ...
                    <div className="bg-white dark:bg-darkPrimary-950 border border-primary-200 dark:border-darkPrimary-700/50 rounded-lg p-6 space-y-4">
                        ...
                        <button 
                            ...
                            disabled={solana.loading || siws.isLoading || isCheckingContribution || (solana.connected && siws.isAuthenticated && (isAmountInvalid || maxAllowedBuy <= 0 || presaleStatus !== 'active'))}
                        >
                            {buttonText}
                        </button>
