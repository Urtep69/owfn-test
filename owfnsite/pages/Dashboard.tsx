...
const WalletCardSkeleton = () => (
    <div className="bg-white dark:bg-darkPrimary-800 p-6 rounded-lg shadow-3d">
        <div className="space-y-3 animate-pulse">
            <div className="h-6 bg-primary-200 dark:bg-darkPrimary-700 rounded w-3/4"></div>
            <div className="h-4 bg-primary-200 dark:bg-darkPrimary-700 rounded w-1/2"></div>
            <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="h-12 bg-primary-100 dark:bg-darkPrimary-700/50 rounded-lg"></div>
                <div className="h-12 bg-primary-100 dark:bg-darkPrimary-700/50 rounded-lg"></div>
            </div>
            <div className="space-y-2 pt-2">
                <div className="h-10 bg-primary-100 dark:bg-darkPrimary-700/50 rounded-md"></div>
                <div className="h-10 bg-primary-100 dark:bg-darkPrimary-700/50 rounded-md"></div>
                <div className="h-10 bg-primary-100 dark:bg-darkPrimary-700/50 rounded-md"></div>
            </div>
        </div>
...
const WalletCard = ({ walletInfo }: { walletInfo: Omit<Wallet, 'balances' | 'totalUsdValue'> }) => {
    ...
    return (
        <div className="bg-white dark:bg-darkPrimary-800 p-6 rounded-lg shadow-3d transition-transform transform hover:scale-105">
