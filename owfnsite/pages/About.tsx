...
export default function About() {
    ...
    return (
        <div className="animate-fade-in-up space-y-12">
            ...
            <div className="p-8 bg-white dark:bg-darkPrimary-800 rounded-lg shadow-3d golden-border">
            ...
            <div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <Link href="/impact/category/health">
                        <a className="block text-center p-6 bg-white dark:bg-darkPrimary-800 rounded-lg shadow-3d hover:shadow-3d-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer golden-border">
