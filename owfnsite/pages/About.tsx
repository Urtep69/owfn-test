    ...
    return (
        <div className="animate-fade-in-up space-y-12">
            <div className="text-center">
                <h1 className="text-4xl font-bold font-display text-accent-light">{t('about_title')}</h1>
                <p className="mt-4 text-lg text-text-secondary">
                    {t('about_subtitle')}
                </p>
            </div>

            <div className="p-8 glassmorphism rounded-lg">
            ...
            <div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <Link href="/impact/category/health">
                        <a className="block text-center p-6 glassmorphism rounded-lg hover:shadow-glow-accent hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                            <HeartHandshake className="mx-auto text-accent-light w-12 h-12 mb-4" />
                    ...
                    <Link href="/impact/category/education">
                         <a className="block text-center p-6 glassmorphism rounded-lg hover:shadow-glow-accent hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                            <BookOpen className="mx-auto text-accent-light w-12 h-12 mb-4" />
                    ...
                    <Link href="/impact/category/basic-needs">
                        <a className="block text-center p-6 glassmorphism rounded-lg hover:shadow-glow-accent hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                            <HomeIcon className="mx-auto text-accent-light w-12 h-12 mb-4" />
