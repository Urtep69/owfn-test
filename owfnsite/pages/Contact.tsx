...
export default function Contact() {
    ...
    return (
        <div className="animate-fade-in-up space-y-12">
            ...
            {isAdmin && (
                <section className="glassmorphism p-8 rounded-lg">
                    <h2 className="text-3xl font-bold text-center mb-8">{t('contact_form_title')}</h2>
                    {status === 'success' ? (
                        <div className="text-center p-8 bg-success/10 rounded-lg animate-fade-in-up">
                            <CheckCircle className="mx-auto w-16 h-16 text-success mb-4" />
                            <h3 className="text-2xl font-bold text-success">{t('contact_success_title')}</h3>
