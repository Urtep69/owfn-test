...
const DetailItem = ({ label, value }: { label: string, value: React.ReactNode }) => (
    <div className="flex justify-between items-center py-3 border-b border-primary-200 dark:border-darkPrimary-700">
        ...
        <span className="font-semibold text-primary-900 dark:text-primary-100 text-right">{value}</span>
    </div>
);
    ...
    return (
        <div className="animate-fade-in-up">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-accent-600 dark:text-darkAccent-500">{t('tokenomics_title')}</h1>
            ...
            <div className="mt-12 bg-primary-50 dark:bg-darkPrimary-800 p-8 rounded-lg shadow-neo-brutal dark:shadow-dark-neo-brutal border-2 border-primary-900 dark:border-primary-100">
