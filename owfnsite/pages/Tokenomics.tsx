...
const DetailItem = ({ label, value }: { label: string, value: React.ReactNode }) => (
    <div className="flex justify-between items-center py-3 border-b border-primary-700">
        <span className="text-primary-400">{label}</span>
        <span className="font-semibold text-primary-100 text-right">{value}</span>
    </div>
);
    ...
    return (
        <div className="animate-fade-in-up">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-accent-400">{t('tokenomics_title')}</h1>
            ...
            <div className="mt-12 bg-primary-800 p-8 rounded-lg shadow-3d">
