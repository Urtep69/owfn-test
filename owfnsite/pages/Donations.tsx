...
export default function Donations() {
    ...
    return (
        <div className="animate-fade-in-up space-y-12">
            ...
            <div className="glassmorphism p-8 md:p-12 rounded-2xl shadow-glow-lg transform hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="bg-danger/10 border-l-4 border-danger text-danger p-4 rounded-md shadow-md flex items-start space-x-3">
