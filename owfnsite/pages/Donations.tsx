...
export default function Donations() {
    ...
    return (
        <div className="animate-fade-in-up space-y-12">
            ...
            <div className="bg-white dark:bg-darkPrimary-800 p-8 md:p-12 rounded-2xl shadow-3d-lg transform hover:scale-[1.02] transition-transform duration-300 golden-border">
            ...
            <div className="bg-white dark:bg-darkPrimary-800 p-8 rounded-lg shadow-3d max-w-2xl mx-auto golden-border">
                ...
                <div className="space-y-6">
                    ...
                    {solana.connected && (
                     ...
                     <button onClick={handleDonate} disabled={solana.loading || !solana.connected || !(parseFloat(amount) > 0)} className="w-full bg-gradient-to-r from-accent-400 to-accent-500 text-accent-950 font-bold py-3 rounded-lg text-xl hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed btn-golden">
