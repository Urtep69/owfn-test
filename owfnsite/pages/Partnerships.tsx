...
export default function Partnerships() {
    ...
    return (
        <div className="animate-fade-in-up text-center py-8 max-w-4xl mx-auto space-y-12">
            <div>
                <Handshake className="mx-auto w-24 h-24 text-neon-cyan mb-6" />
                <h1 className="text-4xl font-bold text-text-primary" style={{ textShadow: '0 0 10px var(--neon-cyan)' }}>{t('partnerships_title')}</h1>
            </div>
            ...
            <div className="bg-neon-cyan/10 border-l-4 border-neon-cyan p-6 rounded-md text-left">
                 <h2 className="text-2xl font-bold text-neon-cyan mb-2">{t('partnerships_invitation_title')}</h2>
             ...
             <p className="text-md text-text-secondary/80 pt-4">
