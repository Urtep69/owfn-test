...
const FaqItem = ({ question, answer, isOpen, onClick }: { question: string, answer: string, isOpen: boolean, onClick: () => void }) => {
    return (
        <div className="border-b border-border py-4 last:border-b-0">
            <button
                onClick={onClick}
                className="w-full flex justify-between items-center text-left text-lg font-semibold text-foreground"
            >
                <span>{question}</span>
            ...
            >
                <p className="text-foreground-muted leading-relaxed pt-2 whitespace-pre-wrap">
                    {answer}
                </p>
            </div>
        </div>
    ...
    return (
        <div className="animate-fade-in-up max-w-4xl mx-auto space-y-8">
            <div className="text-center">
                <HelpCircle className="mx-auto w-16 h-16 text-primary mb-4" />
                <h1 className="text-4xl font-bold text-primary">{t('faq_title')}</h1>
            ...
            <div className="space-y-4">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-background border border-border rounded-lg focus:ring-2 focus:ring-ring focus:border-ring focus:outline-none transition-colors"
                    />
                </div>
