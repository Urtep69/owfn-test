...
const FaqItem = ({ question, answer, isOpen, onClick }: { question: string, answer: string, isOpen: boolean, onClick: () => void }) => {
    return (
        <div className="border-b border-slate-200 dark:border-slate-700 py-4 last:border-b-0">
            <button
                onClick={onClick}
            ...
            >
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed pt-2 whitespace-pre-wrap">
                    {answer}
                </p>
            </div>
        </div>
    ...
    return (
        <div className="animate-fade-in-up max-w-4xl mx-auto space-y-8">
            <div className="text-center">
                <HelpCircle className="mx-auto w-16 h-16 text-primary-500 mb-4" />
                <h1 className="text-4xl font-bold text-primary-600 dark:text-primary-400">{t('faq_title')}</h1>
            ...
            <div className="space-y-4">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:outline-none transition-colors"
                    />
                </div>
