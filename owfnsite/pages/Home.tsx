    ...
    return (
        <div className="space-y-24 animate-fade-in-up">
            <section className="relative text-center min-h-[80vh] flex flex-col justify-center items-center overflow-hidden -mt-16">
                {/* New Spline 3D Object reflecting the project's mission */}
                <div className="absolute inset-0 z-0">
                     <spline-viewer
                        url="https://prod.spline.design/QW-V4tn1dC2e1Kbf/scene.splinecode"
                ...
                <div className="relative z-10 flex flex-col items-center p-4">
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
                        <Link to="/presale" className="group text-accent-foreground bg-gradient-to-r from-accent to-accent-light font-bold py-3 px-8 rounded-full text-lg transition-transform transform hover:scale-105 shadow-lg hover:shadow-glow-accent flex items-center gap-2">
                            <span>{t('presale')}</span>
                            <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
                        </Link>
                        <Link to="/about" className="bg-surface border-2 border-border-color text-text-primary font-bold py-3 px-8 rounded-full text-lg hover:bg-surface-light hover:border-accent transition-all transform hover:scale-105 shadow-card">
                            {t('about')}
                        </Link>
                    </div>
                </div>
            ...
            <section className="container mx-auto">
                <div className="text-center p-8 glassmorphism-dark rounded-2xl">
