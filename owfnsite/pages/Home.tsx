...
export default function Home() {
    ...
    return (
        <div className="space-y-16 animate-fade-in-up">
            <section className="text-center bg-gradient-to-br from-white to-primary-200 dark:from-darkPrimary-800 dark:to-darkPrimary-950 rounded-3xl p-8 md:p-16 shadow-3d-lg -mt-8 -mx-8 golden-border">
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
                        <Link to="/presale" className="bg-accent-400 text-accent-950 font-bold py-3 px-8 rounded-full text-lg hover:bg-accent-500 transition-transform transform hover:scale-105 shadow-lg btn-golden">
                            {t('presale')}
                        </Link>
                        <Link to="/about" className="bg-transparent border-2 border-accent-400 text-accent-500 font-bold py-3 px-8 rounded-full text-lg hover:bg-accent-400/20 transition-transform transform hover:scale-105 btn-outline-golden">
                            {t('about')}
                        </Link>
                    </div>
                </div>
