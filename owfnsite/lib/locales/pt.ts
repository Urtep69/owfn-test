...
export const pt = {
    ...
    faq_a1: 'A OWFN (Official World Family Network) é um token baseado na Solana projetado para unir famílias globalmente através da tecnologia blockchain, focando em impacto social, educação, saúde e ajuda humanitária com total transparência.',
    ...
    faq_a5: 'A OWFN é um Token Portador de Juros (IBT) que recompensa automaticamente seus detentores com um Rendimento Percentual Anual (APY) de 2%. Isso significa que suas participações em OWFN crescerão com o tempo simplesmente por mantê-las em sua carteira.',
    ...
    presale_purchases: 'Compras na Pré-venda',
