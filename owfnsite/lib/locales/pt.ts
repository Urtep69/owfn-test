...
export const pt = {
    ...
    partnerships_vision_title: `Uma Visão Compartilhada para o Impacto Global`,
    ...
    partnerships_invitation_desc: `Se esta visão ressoa com sua organização, convidamos você a acompanhar nosso progresso. Por favor, prepare sua proposta delineando como uma colaboração poderia amplificar nossa missão compartilhada. Os detalhes de contato serão mais proeminentes, e abriremos canais formais de discussão após a conclusão da fase de pré-venda.`,
    ...
    faq_search_placeholder: `Procurar uma pergunta...`,
    faq_search_aria_label: `Procurar nas perguntas frequentes`,
    ...
    faq_a4: `A OWFN utiliza a blockchain da Solana para registrar todas as transações relacionadas ao seu Tesouro de Impacto. Isso garante que cada doação e alocação seja publicamente verificável e imutável, proporcionando total transparência.`,
    ...
    faq_a14: `Significa que o token OWFN está programado para gerar juros automaticamente. Apenas mantendo os tokens em sua carteira compatível com Solana, a quantidade de seus tokens aumentará com o tempo, com um Rendimento Percentual Anual (APY) de 2%. Não é necessário fazer staking ou qualquer ação adicional; as recompensas se acumulam automaticamente.`,
    faq_q15: `O que é a taxa de transferência de 0,5% e quando será ativada?`,
    faq_a15: `Esta taxa é um mecanismo chave para o financiamento de longo prazo de nossa missão. Uma taxa de 0,5% será aplicada a todas as transações com o token OWFN *após* o término do período de pré-venda. Os fundos arrecadados com esta taxa são direcionados automaticamente para o Tesouro de Impacto para financiar continuamente nossos projetos sociais. Assim, cada transação contribui para o bem comum.`,
    faq_q16: `Por que vocês escolheram a blockchain Solana para este projeto?`,
    faq_a16: `Escolhemos a Solana por sua velocidade excepcional, custos de transação muito baixos e alta escalabilidade. Essas características são essenciais para um projeto global como o nosso, permitindo micro-transações eficientes e garantindo uma experiência rápida e acessível para todos os usuários, seja doando, comprando ou negociando tokens.`,
    ...
    faq_a19: `Detalhes sobre a visão e os valores de nossa equipe são apresentados no site. À medida que nos aproximamos do lançamento público, forneceremos mais transparência sobre os membros-chave e conselheiros que contribuem para o sucesso do projeto, respeitando sua segurança e privacidade.`,
    ...
    sol_amount: `Valor de SOL`,
    owfn_to_receive: `OWFN a Receber`,
    date: `Data`,
    transaction: `Transação`,
    airdrop_tool_title: `Ferramenta de Distribuição de Airdrop`,
    airdrop_warning: `AVISO: Esta ferramenta iniciará a distribuição em massa de tokens OWFN para todos os contribuidores da pré-venda. Esta ação é irreversível. Certifique-se de que a pré-venda terminou oficialmente e todos os dados estão corretos.`,
    ...
    contact_general_desc: `Para quaisquer perguntas gerais sobre o projeto.`,
    ...
    contact_disclaimer_message: `Para garantir que nossa equipe possa apoiar efetivamente a comunidade e avançar o projeto, priorizamos as consultas diretamente relacionadas à Official World Family Network. Mensagens fora do tópico, spam ou não solicitadas podem não receber uma resposta. Obrigado por sua compreensão e por nos ajudar a manter o foco em nossa missão.`,
