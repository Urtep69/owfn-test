...
export const pt = {
    ...
    my_impact_dashboard: `Meu Painel de Impacto`,
    total_donated_usd: `Total Doado (USD)`,
    causes_supported: `Causas Apoiadas`,
    number_of_donations: `Número de Doações`,
    unlocked_badges: `Distintivos Desbloqueados`,
    badge_first_donor_title: `Primeiro Doador`,
    badge_first_donor_desc: `Concedido por fazer sua primeira doação para qualquer causa.`,
    badge_health_hero_title: `Herói da Saúde`,
    badge_health_hero_desc: `Concedido por contribuições significativas para causas relacionadas à saúde.`,
    badge_active_voter_title: `Votante Ativo`,
    badge_active_voter_desc: `Concedido por participar de 5 ou mais votações de governança.`,
    my_donation_history: `Meu Histórico de Doações`,
    donation_history_date: `Data`,
    donation_history_token: `Token`,
    donation_history_amount: `Valor`,
    donation_history_cause: `Causa`,
    donation_history_transaction: `Transação`,
    donation_history_loading: `Carregando histórico de doações...`,
    donation_history_empty: `Você ainda não fez nenhuma doação. Suas contribuições aparecerão aqui.`,
    donation_history_general: `Doação Geral`,
    
    // Leaderboards
    leaderboards_desc: `Veja quem são os maiores contribuintes do nosso movimento.`,
    leaderboard_rank: `Classificação`,
    leaderboard_donor: `Doador`,
    leaderboard_total_donated: `Total Doado (USD)`,
    weekly: `Semanal`,
    monthly: `Mensal`,
    all_time: `Total`,
    ...
    faq_a12: `Não, depois de concluir com sucesso a compra de tokens OWFN durante a pré-venda, nenhuma ação adicional é necessária de sua parte. Os tokens são automaticamente reservados para o endereço da sua carteira. No final do período de pré-venda, todos os tokens serão distribuídos automaticamente (airdrop) para as carteiras dos compradores.`,
    faq_q13: `Quando e onde poderei negociar (vender/comprar) tokens OWFN após a pré-venda?`,
    faq_a14: `De acordo com nosso Roteiro, após a conclusão bem-sucedida da pré-venda, procederemos à listagem oficial do token $OWFN em exchanges descentralizadas (DEXs) dentro do ecossistema Solana. A data exata e as plataformas serão anunciadas em nossos canais oficiais.`,
    faq_q15: `Por que existe um limite máximo de compra (Max Buy) na pré-venda?`,
    faq_a16: `O limite máximo de compra é uma medida importante para garantir a distribuição mais justa possível de tokens e para evitar que um pequeno número de grandes investidores ("baleias") controle uma parte significativa do fornecimento. Isso promove uma comunidade mais saudável e descentralizada a longo prazo.`,
    faq_q17: `O que significa que o token é "Portador de Juros" com 2% de APY? Como funciona?`,
    faq_a18: `Esta taxa é um mecanismo chave para o financiamento de longo prazo de nossa missão. Uma taxa de 0,5% será aplicada a todas as transações com o token OWFN *após* a conclusão do período de pré-venda. Os fundos arrecadados com esta taxa são direcionados automaticamente para o Tesouro de Impacto para financiar continuamente nossos projetos sociais. Assim, cada transação contribui para o bem comum.`,
    faq_q19: `Por que você escolheu a blockchain Solana para este projeto?`,
    faq_a20: `Escolhemos a Solana por sua velocidade excepcional, custos de transação muito baixos e alta escalabilidade. Essas características são essenciais para um projeto global como o nosso, permitindo microtransações eficientes e garantindo uma experiência rápida e acessível para todos os usuários, sejam eles doadores, compradores ou negociantes de tokens.`,
    faq_q21: `Como posso ter certeza de que minhas doações chegam às causas que vocês apoiam?`,
    faq_a22: `A transparência é fundamental para nós. Todos os fundos destinados a causas sociais são gerenciados através do Tesouro de Impacto, cujo endereço de carteira é público. Você pode monitorar todas as transações de entrada e saída em um explorador de blocos da Solana, como o Solscan. Além disso, no Portal de Impacto, forneceremos atualizações regulares e relatórios detalhados sobre os projetos financiados.`,
    faq_q23: `Posso propor um caso social ou uma causa a ser financiada pela OWFN?`,
    faq_a24: `Na fase inicial, os projetos são selecionados por nossa equipe com base em critérios rigorosos de impacto e viabilidade. À medida que o projeto avança, implementaremos um sistema de governança (DAO) que permitirá que os membros da comunidade proponham e votem em futuras iniciativas, dando a você um papel direto na direção dos fundos.`,
    faq_q25: `Quem está por trás do projeto OWFN? A equipe é anônima?`,
    faq_a26: `Detalhes sobre a visão e os valores de nossa equipe são apresentados no site. À medida que nos aproximamos do lançamento público, forneceremos mais transparência sobre os membros-chave e conselheiros que contribuem para o sucesso do projeto, respeitando sua segurança e privacidade.`,
    faq_q27: `Quais medidas de segurança vocês tomaram para proteger os fundos do projeto e dos investidores?`,
    faq_a28: `A segurança é nossa principal prioridade. Usamos carteiras multi-assinatura para gerenciar fundos críticos, o que significa que nenhuma transação pode ser aprovada por uma única pessoa. O contrato inteligente do token será auditado por empresas de segurança de renome para identificar e corrigir quaisquer vulnerabilidades potenciais antes do lançamento.`,
    ...
    chatbot_welcome_message: `Bem-vindo à OWFN! Como posso ajudá-lo hoje?`,
