export const pt = {
    ...
    home_feature_community_desc: 'Nossa força é nossa comunidade. Seu apoio impulsiona directamente iniciativas sociais em todo o mundo.',
    ...
    donation_fee_info: 'Doações diretas atualmente não têm taxas. Após a conclusão da pré-venda, uma taxa de transferência de 0,5% em todas as transações de $OWFN será ativada para financiar perpetuamente a Tesouraria de Impacto.',
    ...
    badge_community_voter_desc: 'Concedido por participar em 5 votações de governança.',
    ...
    milestone_75: 'Relatório de meio do projeto e verificação.',
    milestone_100: 'Projeto concluído e relatório final emitido.',
    case_update_1: 'Materiais chegaram ao local. A construção está programada para começar na próxima semana!',
    ...
    faq_a4: 'A OWFN utiliza a blockchain Solana para registrar todas as transações relacionadas à sua Tesouraria de Impacto. Isso garante que cada doação e alocação sejam publicamente verificáveis e imutáveis, oferecendo total transparência.',
    ...
    whitepaper_community_desc: 'Junte-se à nostra comunidade em crescimento e mantenha-se atualizado com as últimas notícias:',
    ...
    stake_success_alert: 'Staking de {amount} OWFN realizado com sucesso!',
    unstake_success_alert: 'Unstake de {amount} OWFN realizado com sucesso!',
    claim_success_alert: 'Recompensas de {amount} OWFN reivindicadas com sucesso!',
    ...
    vesting_claim_success: 'Reivindicação de {amount} tokens OWFN em vesting realizada com sucesso!',
