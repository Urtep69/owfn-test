export const pt = {
    ...
    donated: 'Doado',
    donation_success_alert: 'Doação bem-sucedida! Obrigado pela sua contribuição de {amount} {tokenSymbol}.',
    ...
    case_donation_success_alert: 'Obrigado pela sua doação para "{title}"!',
    ...
    chatbot_error: 'Desculpe, estou com problemas para me conectar. Por favor, tente novamente mais tarde.',
    ...
    no_vesting_schedule_desc: 'Nenhum cronograma de vesting associado ao endereço da carteira conectada.',
    ...
    coming_soon_desc: 'Esta funcionalidade está atualmente em desenvolvimento. Estamos trabalhando duro para trazê-la para você em breve. Obrigado pela sua paciência e apoio.',
    ...
    airdrop_log: 'Registro do Airdrop',
};