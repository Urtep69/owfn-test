...
export const pt = {
    ...
    faq_a5: 'A OWFN é um Token Portador de Juros (IBT) que recompensa automaticamente seus detentores com um Rendimento Percentual Anual (APY) de 2%. Isso significa que suas participações em OWFN crescerão ao longo do tempo simply por mantê-las em sua carteira.',
    ...
    vote_success_alert: 'Seu voto foi computado com sucesso!',
    ...
    no_vesting_schedule_desc: 'Não há nenhum cronograma de vesting associado ao endereço de carteira conectado.',
