...
export const pt = {
    ...
    contact_disclaimer_message: `Para garantir que nossa equipe possa apoiar efetivamente a comunidade e avançar o projeto, damos prioridade a consultas diretamente relacionadas à Official World Family Network. Mensagens que não são sobre o assunto, spam ou não solicitadas podem não receber uma resposta. Obrigado por sua compreensão e por nos ajudar a manter o foco em nossa missão.`,
    ...
    contact_social_telegram_group_desc: `Junte-se ao nosso grupo comunitário para discutir e interagir com outros membros.`,
    contact_social_discord_title: `Servidor do Discord`,
    contact_social_discord_desc: `Faça parte da nossa comunidade ativa para discussões e suporte.`,
};
