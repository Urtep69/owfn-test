export const pt = {
    ...
    faq_a5: 'A OWFN é um Token Portador de Juros (IBT) que recompensa automaticamente seus detentores com um Rendimento Percentual Anual (APY) de 2%. Isso significa que suas participações em OWFN crescerão ao longo do tempo simplesmente mantendo-as em sua carteira.',
    ...
    faq_q8: 'Como a minha contribuição, através da compra de tokens, realmente ajuda?',
    ...
    whitepaper_subtitle: 'Uma Visão Geral Detalhada do Projeto da Rede Familiar Mundial Oficial',
    ...
    airdrop_summary: '{success} com sucesso, {failed} com falha.',
