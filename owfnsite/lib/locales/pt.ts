export const pt = {
    ...
    home_feature_community_desc: 'Nossa força é nossa comunidade. Seu apoio impulsiona directamente as iniciativas sociais em todo o mundo.',
    ...
    donation_message_p2_part1: 'Sua contribuição, independentemente da criptomoeda escolhida, transforma-se. Torna-se a fundação de uma nova escola, um refúgio seguro onde o potencial de uma criança pode florescer. Transforma-se em cuidados médicos vitais para uma família que havia perdido toda a esperança. Torna-se uma refeição quente para alguém marginalizado pela sociedade, um lar digno para um idoso, ou os materiais necessários para reconstruir uma comunidade devastada por um desastre. Através da transparência oferecida pela blockchain Solana, a ',
    ...
    funded: 'Financiado',
    view_case: 'Ver Caso',
    admin_portal: 'Portal de Administração',
    ...
    faq_q5: 'O que significa 2% de APY для os detentores de OWFN?',
    ...
    whitepaper_subtitle: 'Uma Visão Detalhada do Projeto da Rede Familiar Mundial Oficial',
    ...
    verified_by_owfn: 'Verificado pela Análise da OWFN',
    no_risk_factors_found: 'Nenhum fator de risco crítico como metadados mutáveis ou autoridades não revogadas encontrado.',
    ...
    claim_success_alert: '{amount} de recompensas OWFN reivindicadas com sucesso!',
    ...
    vesting_subtitle: 'Acompanhe seus cronogramas de vesting de tokens e reivindique os tokens desbloqueados.',
    ...
    vesting_claim_success: '{amount} de tokens OWFN em vesting reivindicados com sucesso!',
    ...
    coming_soon_desc: 'Este recurso está atualmente em desenvolvimento. Estamos trabalhando duro para disponibilizá-lo para você em breve. Obrigado por sua paciência e apoio.',
