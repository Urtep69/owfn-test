export const pt = {
    ...
    presale_whitelist_finished: 'Venda da Lista Branca Concluída:',
    presale_public_ending_in: 'Venda Pública terminando em:',
    ...
    live_presale_feed: 'Feed de Pré-venda ao Vivo',
    wallet: 'Carteira',
    sol_spent: 'SOL Gasto',
    ...
    badge_community_voter: 'Eleitor da Comunidade',
    ...
    back_to_category_cases: 'Voltar aos casos de {category}',
    ...
    case_update_2: 'Os planos de arquitetura foram finalizados e aprovados pelas autoridades locais.',
    ...
    faq_a4: `A OWFN utiliza a blockchain Solana para registrar todas as transações relacionadas ao seu Tesouro de Impacto. Isso garante que cada doação e alocação sejam publicamente verificáveis e imutáveis, proporcionando total transparência.`,
    faq_q5: 'O que significa 2% de APY para os detentores de OWFN?',
    faq_a5: `A OWFN é um Token Portador de Juros (IBT) que recompensa automaticamente seus detentores com um Rendimento Percentual Anual (APY) de 2%. Isso significa que suas posses de OWFN crescerão ao longo do tempo simplesmente mantendo-as em sua carteira.`,
    ...
    faq_a8: `Quando você compra tokens OWFN, uma parte significativa dos fundos vai diretamente para o Tesouro de Impacto. Este tesouro é especificamente alocado para financiar nossos projetos de impacto social. A tecnologia blockchain garante total transparência, o que significa que você pode verificar como os fundos são utilizados. Sua compra não é apenas um investimento; é uma contribuição direta para um fundo dedicado a melhorar vidas e comunidades em todo o mundo.`,
    faq_q9: `Além de comprar tokens, de que outra forma posso me envolver e ajudar a OWFN?`,
    faq_a9: `O seu envolvimento é crucial! Divulgar a palavra sobre a OWFN é incrivelmente poderoso. Fale com os seus amigos, familiares e colegas sobre a nossa missão. Partilhe a nossa visão nas redes sociais, durante as suas viagens ou no trabalho. Cada conversa, cada partilha, ajuda a aumentar a consciencialização e a trazer mais pessoas para a nossa família global, amplificando o nosso impacto coletivo. Junte-se aos nossos canais comunitários para se manter atualizado e participar nas discussões.`,
    faq_q10: `Existem instruções especiais para doar USDC ou USDT?`,
    faq_a10: `Sim, isto é de importância crítica. Todas as doações de USDC e USDT devem ser enviadas *exclusivamente* da blockchain Solana. Não envie de nenhuma outra rede (por exemplo, Ethereum), pois os fundos serão perdidos e não chegarão ao seu destino. Esta informação também está claramente exibida na página de doações.`,
    ...
    whitepaper_features_desc: 'A plataforma OWFN oferece várias funcionalidades chave para apoiar a sua missão:',
    whitepaper_feature_presale: 'Permite que os primeiros apoiantes comprem tokens OWFN antes do lançamento público.',
    whitepaper_feature_donations: 'Um portal dedicado para fazer doações diretas de criptomoedas para o Tesouro de Impacto.',
    whitepaper_feature_dashboard: 'Oferece monitorização em tempo real de todas as carteiras oficiais do projeto para total transparência.',
    whitepaper_feature_impact_portal: 'Mostra casos sociais específicos financiados pelo projeto, permitindo que a comunidade veja o seu impacto.',
    whitepaper_community_title: 'Comunidade e Links Oficiais',
    whitepaper_community_desc: 'Junte-se à nossa comunidade em crescimento e mantenha-se atualizado com as últimas notícias:',

    // Alerts & Messages
    transaction_success_alert: 'Transação bem-sucedida! Você enviou {amount} {tokenSymbol}.',
    transaction_failed_alert: 'Transação falhou. Por favor, tente novamente.',
    ...
    vote_success_alert: 'O seu voto foi registado com sucesso!',
    ...
    project_reliability_score: 'Pontuação de fiabilidade do projeto com base em:',
    audit_title: 'Auditoria',
    verify_external_audits: 'Verificar auditorias externas',
    contract_verified: 'Contrato Verificado',
    honeypot: 'Honeypot',
    freezable: 'Congelável',
    mintable: 'Cunhável',
    check_audits: 'Verificar Auditorias (Alertas: {count})',
    community_trust_title: 'Confiança da Comunidade',
    of_trades: 'de {total} negociações',
    token_description_title: 'DESCRIÇÃO DO TOKEN',
    live_transactions: 'Transações ao Vivo',
    type: 'Tipo',
    price_usd: 'Preço USD',
    ...
    airdrop_info_box_desc: 'Este airdrop foi projetado para recompensar os primeiros apoiantes e membros ativos da comunidade. A elegibilidade é baseada em fatores como participação na pré-venda e envolvimento em eventos da comunidade.',
    ...
    // Maintenance
    maintenance_heading: 'Estamos a melhorar as coisas!',
    maintenance_message: 'A nossa plataforma está atualmente em manutenção programada para mejorar a sua experiência. Agradecemos a sua paciência e compreensão. Estaremos de volta online em breve.',
    maintenance_stay_tuned: 'Fique atento às atualizações nos nossos canais sociais:',
    ...
    coming_soon_desc: 'Esta funcionalidade está atualmente em desenvolvimento. Estamos a trabalhar arduamente para a disponibilizar em breve. Agradecemos a sua paciência e apoio.',
};