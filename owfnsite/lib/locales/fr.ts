...
export const fr = {
    ...
    donation_solana_warning: `IMPORTANT : Les dons en USDC et USDT ne sont currently acceptés QUE depuis le réseau Solana. N'envoyez pas depuis un autre réseau (par exemple, Ethereum) car les fonds seront perdus et n'atteindront pas leur destination.`,
    ...
    faq_a11: `Non, après avoir finalisé avec succès l'achat de jetons OWFN lors de la prévente, aucune autre action n'est requise de votre part. Les jetons sont automatiquement réservés à l'adresse de votre portefeuille. À la fin de la période de prévente, tous les jetons seront automatiquement distribués (via airdrop) aux portefeuilles des acheteurs.`,
    faq_q12: `Quand et où pourrai-je échanger (vendre/acheter) des jetons OWFN après la prévente ?`,
    faq_a12: `Selon notre feuille de route, après la conclusion réussie de la prévente, nous procéderons à la cotation officielle du jeton $OWFN sur les bourses décentralisées (DEX) de l'écosystème Solana. La date exacte et les plateformes seront annoncées sur nos canaux officiels.`,
    faq_q13: `Pourquoi y a-t-il une limite d'achat maximale (Max Buy) lors de la prévente ?`,
    faq_a13: `La limite d'achat maximale est une mesure importante pour assurer une distribution des jetons aussi équitable que possible et pour empêcher qu'un petit nombre de gros investisseurs ("baleines") ne contrôle une part importante de l'offre. Cela favorise une communauté plus saine et plus décentralisée à long terme.`,
    faq_q14: `Que signifie que le jeton est "porteur d'intérêts" avec un APY de 2% ? Comment ça marche ?`,
    faq_a14: `Cela signifie que le jeton OWFN est programmé pour générer automatiquement des intérêts. En conservant simplement les jetons dans votre portefeuille compatible Solana, la quantité de vos jetons augmentera avec le temps, avec un rendement annuel en pourcentage (APY) de 2%. Vous n'avez pas besoin de les staker ou de prendre des mesures supplémentaires ; les récompenses s'accumulent automatiquement.`,
    faq_q15: `Qu'est-ce que la commission de transfert de 0,5% et quand sera-t-elle activée ?`,
    ...
    admin_controls: `Contrôles d'administration`,
