...
export const fr = {
    ...
    presale_purchase_success_alert: `Achat réussi ! Vous avez contribué à hauteur de {amount} SOL. Vos {owfnAmount} jetons OWFN sont réservés et seront automatiquement distribués par airdrop à votre portefeuille à la fin de la prévente.`,
    ...
    donation_fee_info: `Les dons directs sont currently sans frais. Après la fin de la prévente, des frais de transfert de 0,5 % sur toutes les transactions $OWFN seront activés pour financer perpétuellement la Trésorerie d'Impact.`,
    ...
    faq_a9: `Votre implication est cruciale ! Répandre la nouvelle sur OWFN est incroyablement puissant. Parlez à vos amis, votre famille et vos collègues de notre mission. Partagez notre vision sur les réseaux sociaux, lors de vos voyages ou au travail. Chaque conversation, chaque partage, aide à sensibiliser et à amener plus de gens dans notre famille mondiale, amplifiant notre impact collectif. Rejoignez nos canaux communautaires pour rester à jour et participer aux discussions.`,
    ...
    faq_a11: `Non, une fois que vous avez finalisé avec succès l'achat de jetons OWFN pendant la prévente, aucune autre action n'est requise de votre part. Les jetons sont automatiquement réservés à l'adresse de votre portefeuille. À la fin de la période de prévente, tous les jetons seront automatiquement distribués (via airdrop) aux portefeuilles des acheteurs.`,
    faq_q12: `Quand et où pourrai-je échanger (vendre/acheter) les jetons OWFN après la prévente ?`,
    ...
    faq_q14: `Que signifie que le jeton est "porteur d'intérêts" (Interest-Bearing) avec un APY de 2% ? Comment cela fonctionne-t-il ?`,
    faq_a14: `Cela signifie que le jeton OWFN est programmé pour générer automatiquement des intérêts. Simplement en détenant les jetons dans votre portefeuille compatible avec Solana, la quantité de vos jetons augmentera avec le temps, avec un rendement annuel en pourcentage (APY) de 2%. Il n'est pas nécessaire de les mettre en staking ou de prendre des mesures supplémentaires ; les récompenses s'accumulent automatiquement.`,
    ...
    faq_q19: `Qui se cache derrière le projet OWFN ? L'équipe est-elle anonyme ?`,
    faq_a19: `Des détails sur la vision et les valeurs de notre équipe sont présentés sur le site web. À l'approche du lancement public, nous fournirons plus de transparence concernant les membres clés et les conseillers qui contribuent au succès du projet, tout en respectant leur sécurité et leur vie privée.`,
    ...
    whitepaper_features_desc: 'La plateforme OWFN fournit plusieurs fonctionnalités clés pour soutenir sa mission :',
    ...
    // Token Detail Page
    token_detail_title: 'Analyse de Jeton',
    ...
    airdrop_subtitle: 'Vérifiez votre éligibilité pour nos airdrops communautaires et récompenses.',
    ...
    airdrop_warning: `AVERTISSEMENT : Cet outil lancera la distribution de masse des jetons OWFN à tous les contributeurs de la prévente. Cette action est irréversible. Assurez-vous que la prévente est officiellement terminée et que toutes les données sont correctes.`,
    ...
    contact_form_reason: 'Motif du Contact',
    ...
    contact_social_x_desc: 'Suivez-nous pour les mises à jour en temps réel, les actualités et les annonces.',
    contact_social_telegram_channel_title: 'Canal Telegram',
    contact_social_telegram_channel_desc: 'Abonnez-vous pour les annonces majeures et les nouvelles officielles.',
