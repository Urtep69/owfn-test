...
export const fr = {
    ...
    faq_a7: `L'OWFN finance directement des initiatives dans des domaines critiques tels que la santé (par ex. couverture des frais de chirurgie, modernisation des hôpitaux), l'éducation (par ex. construction et rénovation d'écoles, de jardins d'enfants) et les besoins de base (par ex. fourniture de nourriture, d'abri, de vêtements pour les sans-abri, création de maisons de retraite). Nous répondons également aux secours en cas de catastrophe et investissons dans des projets de développement communautaire durable. Chaque jeton contribue à ces actions concrètes, garantissant un soutien 100% réel à l'humanité.`,
    faq_q8: `Comment ma contribution, en achetant des jetons, aide-t-elle réellement ?`,
    faq_a8: `Votre contribution aide de deux manières fondamentales. Premièrement, lorsque vous achetez des jetons pendant la prévente, une partie importante des fonds va directement dans la Trésorerie d'Impact pour lancer nos projets sociaux. Deuxièmement, pour créer une source de financement durable à long terme, des frais de transfert de 0,5% seront activés sur toutes les transactions *après* la fin de la période de prévente. Ces frais sont conçus comme un micro-don automatique à la Trésorerie d'Impact. Cela signifie que chaque fois que le jeton sera utilisé à l'avenir, il générera un soutien continu pour nos causes humanitaires, transformant l'ensemble de l'écosystème en une force perpétuelle pour le bien. Tous ces flux financiers sont entièrement transparents sur la blockchain.`,
    faq_q9: `En dehors de l'achat de jetons, comment puis-je m'impliquer et aider l'OWFN ?`,
    faq_a9: `Votre implication est cruciale ! Faire connaître l'OWFN est incroyablement puissant. Parlez de notre mission à vos amis, votre famille et vos collègues. Partagez notre vision sur les réseaux sociaux, lors de vos voyages ou au travail. Chaque conversation, chaque partage, contribue à sensibiliser et à attirer plus de personnes dans notre famille mondiale, amplifiant ainsi notre impact collectif. Rejoignez nos canaux communautaires pour rester à jour et participer aux discussions.`,
    ...
    faq_a13: `La limite d'achat maximale est une mesure importante pour garantir une distribution de jetons aussi équitable que possible et pour empêcher qu'un petit nombre de grands investisseurs ("baleines") ne contrôle une part importante de l'offre. Cela favorise une communauté plus saine et plus décentralisée à long terme.`,
    faq_q14: `Que signifie que le jeton est "Porteur d'Intérêts" avec un APY de 2% ? Comment cela fonctionne-t-il ?`,
    faq_a14: `Cela signifie que le jeton OWFN est programmé pour générer automatiquement des intérêts. En conservant simplement les jetons dans votre portefeuille compatible avec Solana, la quantité de vos jetons augmentera avec le temps, avec un rendement annuel en pourcentage (APY) de 2%. Il n'est pas nécessaire de les mettre en staking ou de prendre des mesures supplémentaires ; les récompenses s'accumulent automatiquement.`,
    ...
    // Token Detail Page
    token_detail_title: `Analyse des Jetons`,
    ...
    is_mintable: `Est-ce que c'est frappables ?`,
    is_freezable: `Est-ce que c'est gelables ?`,
    deployer: `Déployeur`,
    lp_burned: `LP Brûlé`,
    enabled: `Activé`,
    disabled: `Désactivé`,
    ...
    unstake_success_alert: `Vous avez déstaké {amount} OWFN avec succès !`,
