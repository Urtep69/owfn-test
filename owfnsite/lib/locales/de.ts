...
export const de = {
    ...
    faq_q8: 'Wie hilft mein Beitrag durch den Token-Kauf tatsächlich?',
    ...
    faq_q9: 'Wie kann ich mich außer dem Kauf von Tokens sonst noch engagieren und OWFN helfen?',
