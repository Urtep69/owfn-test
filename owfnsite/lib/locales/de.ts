...
export const de = {
    ...
    presale_min_amount_error: `Der Betrag muss mindestens {min} SOL betragen.`,
    ...
    faq_search_placeholder: `Suchen Sie nach einer Frage...`,
    faq_search_aria_label: `Durchsuchen Sie die häufig gestellten Fragen`,
    ...
    faq_category_mission: `Mission & Wirkung`,
    ...
    faq_q11: `Was passiert genau, nachdem ich im Vorverkauf Token gekauft habe? Muss ich etwas tun?`,
    faq_a11: `Nein, nachdem Sie den Kauf von OWFN-Token während des Vorverkaufs erfolgreich abgeschlossen haben, ist von Ihrer Seite keine weitere Aktion erforderlich. Die Token werden automatisch für Ihre Wallet-Adresse reserviert. Am Ende des Vorverkaufszeitraums werden alle Token automatisch (per Airdrop) an die Wallets der Käufer verteilt.`,
    faq_q12: `Wann und wo kann ich nach dem Vorverkauf OWFN-Token handeln (verkaufen/kaufen)?`,
    faq_a12: `Gemäß unserer Roadmap werden wir nach erfolgreichem Abschluss des Vorverkaufs mit der offiziellen Listung des $OWFN-Tokens an dezentralen Börsen (DEX) im Solana-Ökosystem fortfahren. Das genaue Datum und die Plattformen werden auf unseren offiziellen Kanälen bekannt gegeben.`,
    ...
    faq_a16: `Wir haben uns für Solana wegen seiner außergewöhnlichen Geschwindigkeit, sehr niedrigen Transaktionskosten und hohen Skalierbarkeit entschieden. Diese Eigenschaften sind für ein globales Projekt wie unseres unerlässlich, ermöglichen effiziente Mikrotransaktionen und gewährleisten eine schnelle und zugängliche Erfahrung für alle Benutzer, egal ob sie spenden, kaufen oder handeln.`,
    ...
    faq_q18: `Kann ich einen sozialen Fall oder eine Sache vorschlagen, die von OWFN finanziert werden soll?`,
    faq_a18: `In der Anfangsphase werden die Projekte von unserem Team auf der Grundlage strenger Kriterien hinsichtlich Wirkung und Durchführbarkeit ausgewählt. Im weiteren Verlauf des Projekts werden wir ein Governance-System (DAO) implementieren, das es den Community-Mitgliedern ermöglicht, zukünftige Initiativen vorzuschlagen und darüber abzustimmen, wodurch Sie eine direkte Rolle bei der Lenkung der Mittel erhalten.`,
    faq_q19: `Wer steckt hinter dem OWFN-Projekt? Ist das Team anonym?`,
    faq_a19: `Details zur Vision und den Werten unseres Teams werden auf der Website vorgestellt. Wenn wir uns der öffentlichen Einführung nähern, werden wir mehr Transparenz über die Schlüsselmitglieder und Berater geben, die zum Erfolg des Projekts beitragen, und dabei deren Sicherheit und Privatsphäre respektieren.`,
    faq_q20: `Welche Sicherheitsmaßnahmen haben Sie ergriffen, um die Gelder des Projekts und der Investoren zu schützen?`,
    faq_a20: `Sicherheit hat für uns oberste Priorität. Wir verwenden Multi-Signatur-Wallets für die Verwaltung kritischer Gelder, was bedeutet, dass keine Transaktion von einer einzelnen Person genehmigt werden kann. Der Smart Contract des Tokens wird von renommierten Sicherheitsfirmen geprüft, um potenzielle Schwachstellen vor der Einführung zu identifizieren und zu beheben.`,
    ...
    whitepaper_feature_dashboard: `Biedt Echtzeitüberwachung aller offiziellen Projekt-Wallets für vollständige Transparenz.`,
    ...
    coming_soon_desc: `Diese Funktion befindet sich derzeit in der Entwicklung. Wir arbeiten hart daran, sie Ihnen bald zur Verfügung zu stellen. Vielen Dank für Ihre Geduld und Ihre Unterstützung.`,
