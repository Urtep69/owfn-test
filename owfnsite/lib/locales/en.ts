export const en = {
    ...
    asset: `Asset`,
    value_usd: `Value (USD)`,
    profile_presale_contribution_title: `Presale Contribution`,
    profile_donation_impact_title: `Donation Impact`,
    profile_total_sol_contributed: `Total SOL Contributed`,
    profile_owfn_to_receive: `OWFN To Receive (incl. bonus)`,
    profile_total_sol_donated: `Total SOL Donated`,
    profile_my_tx_history_title: `My Transaction History`,
    profile_tx_type: `Type`,
    profile_tx_amount: `Amount`,
    profile_tx_date: `Date`,
    profile_tx_type_presale: `Presale Contribution`,
    profile_tx_type_donation: `Donation`,
    profile_scanning_history: `Scanning your transaction history...`,
    profile_no_tx_found: `No presale contributions or donations found for this wallet.`,
    profile_impact_stats_desc: `Your personal contributions to the OWFN ecosystem. Data is scanned directly from the blockchain.`,
