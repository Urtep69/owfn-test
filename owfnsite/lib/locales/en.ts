export const en = {
    ...
    badge_first_donation_desc: `Awarded for making your first donation to the cause.`,
    badge_community_voter_title: `Community Voter`,
    badge_community_voter_desc: `Awarded for participating in a governance vote.`,
    badge_diverse_donor_title: `Diverse Supporter`,
    badge_diverse_donor_desc: `Awarded for donating more than one type of crypto asset.`,
    badge_presale_pioneer_title: `Presale Pioneer`,
    badge_presale_pioneer_desc: `Awarded for participating in the OWFN token presale.`,
    impact_portfolio_chart_title: `Portfolio Distribution`,
