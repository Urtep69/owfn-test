export const en = {
    ...
    faq_q17: 'How can I be sure my donations reach the causes you support?',
    faq_a17: 'Transparency is fundamental to us. All funds destined for social causes are managed through the Impact Treasury, whose wallet address is public. You can monitor all incoming and outgoing transactions on a Solana block explorer, like Solscan. Additionally, on the Impact Portal, we will provide regular updates and detailed reports on the funded projects.',
    ...
    faq_a19: 'Details about our team\'s vision and values are presented on the website. As we get closer to the public launch, we will provide more transparency regarding the key members and advisors contributing to the project\'s success, while respecting their safety and privacy.',
    ...
    whitepaper_features_desc: `The OWFN platform offers several key features to support its mission:`,
    ...
    token_not_found: `Token data could not be found.`,
    ...
    vesting_subtitle: `Track your token vesting schedules and claim your unlocked tokens.`,
    vesting_connect_title: `Connect to View Vesting`,
    vesting_connect_prompt: `Connect your wallet to see your personal vesting schedules.`,
    ...
    coming_soon_desc: `This feature is currently under development. We're working hard to bring it to you soon. Thank you for your patience and support.`,
    ...
    // Airdrop Public Page
    airdrop_tasks_incomplete_title: 'Incomplete Tasks',
    airdrop_tasks_incomplete_desc: 'Please complete all tasks to register for the airdrop.',
    airdrop_register_button: 'Register for Airdrop',
    airdrop_success_title: 'Registration Successful!',
    airdrop_success_desc: 'You have been successfully registered for the airdrop. Rewards will be distributed after verification.',
    airdrop_registered_title: 'Already Registered',
    airdrop_registered_desc: 'This wallet address has already been registered for the airdrop.',
    airdrop_error_title: 'Registration Error',
    airdrop_error_desc: 'An error occurred while processing your registration. Please try again later.',
    airdrop_page_subtitle: 'Complete the tasks below and register your SOL wallet to be eligible for future airdrop rewards.',
    airdrop_join_title: 'Join Our Airdrop',
    airdrop_join_desc: 'Perform the following tasks to qualify for the airdrop.',
    airdrop_task_follow_x: 'Follow on X',
    airdrop_task_join_telegram: 'Join Telegram',
    airdrop_task_join_discord: 'Join Discord',
    airdrop_task_retweet: 'Retweet Pinned Tweet',
    airdrop_rules_title: 'Airdrop Rules & Conditions',
    airdrop_rule_1: 'A valid SOL wallet address is required.',
    airdrop_rule_2: 'Multiple and bot entries are prohibited; verification will be performed.',
    airdrop_rule_3: 'Airdrop distribution will occur after the event conclusion and task verification.',
    airdrop_rule_4: 'OWFN reserves the right to modify the rules or cancel the event at any time.',
};