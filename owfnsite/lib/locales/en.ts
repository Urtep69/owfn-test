export const en = {
    ...
    home_how_it_works_subtitle: `A simple, transparent flow from contribution to impact.`,
    home_social_proof_title: `A Living, Breathing Movement`,
    home_community_buzz_title: `From Our Community`,
    home_partners_title: `Partners & Advisors`,
    home_partners_desc: `We are actively seeking strategic partnerships post-presale. Stay tuned for announcements.`,
    home_join_title: `Join the Movement`,
    home_join_desc: `Become part of a global family dedicated to making a real difference. Your journey starts here.`,
