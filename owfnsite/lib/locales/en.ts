export const en = {
    ...
    help_center_subtitle: `Docs / User Guide`,
    ...
    donation_message_p3: `Your contribution, no matter the size, is a powerful statement of solidarity. It is proof that a global family, united by a compassion, can change the world. You are not just making a donation; you are joining a movement dedicated to building a better future.`,
    ...
    faq_q14: 'What is the 0.5% transfer fee and when is it activated?',
    faq_a14: 'This fee is a key mechanism for the long-term funding of our mission. A 0.5% fee will apply to all transactions with the OWFN token *after* the presale period concludes. The funds collected from this fee are automatically directed to the Impact Treasury to continuously fund our social projects. Thus, every transaction contributes to the common good.',
    faq_q15: 'Why did you choose the Solana blockchain for this project?',
    ...
    chatbot_proactive_home: "Welcome to OWFN! I can help you find information about our mission, the presale, or our tokenomics. What are you interested in?",
    ...
    chatbot_proactive_about: "Want to learn more about OWFN's mission and vision? Ask me anything!",
    chatbot_proactive_whitepaper: "Looking for in-depth details? I can help you find specific information in the Whitepaper.",
    chatbot_proactive_tokenomics: "Curious about our token distribution or the 2% automatic APY? Just ask!",
    chatbot_proactive_roadmap: "Interested in our future plans? I can tell you about the key phases on our roadmap.",
    ...
    contact_faq_button: `View the FAQ`,
    ...
    contact_disclaimer_message: `To ensure our team can effectively support the community and advance the project, we prioritize inquiries directly related to the Official World Family Network. Off-topic messages, spam, or unsolicited pitches may not receive a response. Thank you for your understanding and for helping us stay focused on our mission.`,
    ...
    // AI Features
    ai_summary_button: `Get AI Summary`,
    ai_summary_loading: `Generating...`,
    ai_summary_title: `AI Summary`,
    generated_by_ai: `Generated by AI`,
    impact_narrative_title: `Your Impact Story`,
    impact_narrative_loading: `Crafting your personalized story...`,
    nft_reward_title: `A Special Thank You`,
    nft_reward_button: `Generate Thank You Art`,
    ...
    api_error_generic: `The request could not be completed at this time.`,
    ...
    airdrop_connect_prompt: `Connect your wallet to check if you're eligible for the airdrop.`,
    ...
    // Maintenance
    maintenance_heading: `We're improving things!`,
    maintenance_message: `Our platform is currently undergoing scheduled maintenance to enhance your experience. We appreciate your patience and understanding. We'll be back online shortly.`,
    ...
    // Docs Page
    docs_main_title: `Introduction to OWFN`,
    docs_intro_title: `Introduction to the OWFN Project`,
    docs_intro_p1: `OWFN provides a comprehensive platform for engaging with humanitarian causes on the Solana blockchain. It offers a fully visual interface, making complex processes like transparent donations, presale participation, and monitoring social impact initiatives simple and intuitive.`,
    docs_intro_p2: `This document will further present the positioning of OWFN within the Solana ecosystem as a force for social good. The project's philosophy and future development plan will also be introduced. Whatever our global family needs to create impact, we will build. Our focus is on empowering our community to make a real-world difference.`,
    docs_background_title: `Project Background`,
    docs_background_p1: `The core idea of the OWFN project is to promote fairness and transparency in humanitarian aid. The anonymous founder, a passionate believer in community strength, noticed inefficiencies and lack of transparency in traditional aid systems. To address this, they decided to leverage the power of the Solana blockchain, launching a project that is fair, open, and community-driven from the start, aiming to become the new standard for decentralized social impact.`,
    docs_dev_plan_title: `OWFN Development Plan`,
    docs_dev_plan_p1: `The development plan for OWFN will be split into three execution phases:`,
    docs_dev_plan_initial_title: `Initial Phase`,
    docs_dev_plan_initial_p1: `Initial development includes foundational functions such as token creation, presale management, and an open-source, fully transparent wallet monitoring dashboard.`,
    docs_dev_plan_professional_title: `Professional Phase`,
    docs_dev_plan_professional_p1: `Introduces advanced features such as on-chain governance (DAO), impact case tracking, and transparent donation portals. This phase also enhances the user experience with an AI assistant and a community toolkit to encourage global participation.`,
    docs_dev_plan_extended_title: `Extended Services`,
    docs_dev_plan_extended_p1: `Develops services related to the Solana chain, such as NFT minting tools for impact tracking and auditing tools for NGOs. Through this development pathway, OWFN plans to gradually build a comprehensive, efficient, and reliable suite of tools for the decentralized humanitarian aid ecosystem.`,
    docs_roadmap_title: `OWFN Roadmap`,
    docs_roadmap_overview_title: `Roadmap Overview`,
    docs_roadmap_item1: `Impact Case Management Creation`,
    docs_roadmap_item2: `Liquidity pool creation`,
    docs_roadmap_item3: `Community Governance (DAO)`,
    docs_roadmap_item4: `Bulk sending and aggregation`,
    docs_roadmap_item5: `On-chain messaging`,
    docs_roadmap_additional_services: `Additional wallet address-related services`,
    docs_roadmap_item6: `"Anti-fraud" trades`,
    docs_roadmap_item7: `AI-powered analysis and alerts`,
    docs_roadmap_item8: `Exported token management functions`,
    docs_roadmap_item9: `Project calendar`,
    docs_roadmap_item10: `Wallet value management tools`,
    docs_empower_title: `How to Empower $OWFN?`,
    docs_empower_p1: `OWFN aims to provide the best tools for the Solana blockchain ecosystem. This requires a dedicated team of developers working full-time. Therefore, we will charge certain fees for using the platform to ensure the project's long-term and healthy development. These fees will be collected in $OWFN tokens, which will then be partially burned and partially used for operational expenses, helping to strengthen the value of the tokens.`,
    docs_empower_plan_title: `$OWFN Empowerment Plan`,
    docs_empower_plan_p1: `To increase the application scenarios of $OWFN, the following plans will be executed successively:`,
    docs_empower_plan_item1: `Fee Discounts: Holding a certain amount of $OWFN tokens will grant users discounts on platform fees. For example: holding 100,000 $OWFN for a 10% discount.`,
    docs_empower_plan_item2: `Holding 500,000 $OWFN for a 30% discount.`,
    docs_empower_plan_item3: `Holding 1,000,000 $OWFN for a 50% discount.`,
    docs_empower_plan_item4: `Exclusive Payment: Certain services or features, such as AI-powered auditing tools and advanced governance functions, will require payment in $OWFN tokens.`,
    docs_empower_plan_p2: `This plan aims to encourage the holding and use of $OWFN tokens by offering tangible benefits, thereby increasing the token's utility and value.`,
    docs_relationship_title: `Relationship Between OWFN and Community`,
    docs_relationship_p1: `The relationship between OWFN and its community is symbiotic. By utilizing $OWFN as the core token, we are anchoring platform development in the Solana blockchain ecosystem and strengthening our ties with the community. This also enhances the intrinsic value of the $OWFN token. In return, the growth of the community will support and promote the development of the OWFN tools.`,
    docs_partner_program_title: `OWFN Partner Program`,
    docs_partner_program_p1: `The OWFN Partner Program aims to incentivize SOL and regular users to invite others to use the platform.`,
    docs_partner_program_invitation_title: `Invitation Rewards`,
    docs_partner_program_invitation_p1: `Partners can invite new users to register and use OWFN tools by sharing a unique invitation link or code. Both the partner and the new user will receive certain rewards, enhancing user growth and platform stickiness.`,
    docs_partner_program_system_title: `The System`,
    docs_partner_program_system_p1: `The system will be a tier system that provides different levels of rewards based on the quantity and quality of users invited by partners. We will track and manage partner data to ensure their contributions and earnings are clearly visible. We look forward to having partners join us and grow together.`,
};