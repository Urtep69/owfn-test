export const en = {
    ...
    chatbot_send_transcript: 'Send Transcript by Email',
    chatbot_email_modal_title: 'Send Chat Transcript',
    chatbot_email_modal_desc: 'Enter your email address below to receive a copy of this conversation.',
    chatbot_email_modal_placeholder: 'your.email@example.com',
    chatbot_email_modal_send: 'Send',
    chatbot_email_modal_cancel: 'Cancel',
    chatbot_email_modal_sending: 'Sending...',
    chatbot_email_success_toast: 'Transcript sent successfully to {email}.',
    chatbot_email_error_toast: 'Failed to send transcript. Please try again.',
    chatbot_email_invalid_toast: 'Please enter a valid email address.',
