export const en = {
    ...
    presale_min_amount_error: `Minimum purchase is {min} SOL. Value will be adjusted.`,
    presale_max_amount_error: `Total contribution cannot exceed {max} SOL. You can buy {remaining} more. Value will be adjusted.`,
