export const en = {
    ...
    docs_intro_p1: `OWFN offers a fully cloud-based interface for interacting with Solana blockchain operations. It offers a fully visual interface without the need for programming, making complex processes such as creating markets, managing liquidity, and executing bulk token operations simple and intuitive.`,
    docs_intro_p2: `This document will further present the positioning of OWFN within the Solana blockchain ecosystem. The operating philosophy and future development plan of the tools will also be introduced. Whatever Solana users need, we will create. Our focus and expertise in satisfying users' needs make us professional.`,
