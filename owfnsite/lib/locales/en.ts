export const en = {
    ...
    // Community Hub
    community: 'Community',
    community_hub_welcome_title: 'Welcome to the Community Hub',
    community_hub_welcome_desc: 'Connect your wallet to join the conversation, chat with other members, and access exclusive groups.',
    community_select_conversation_title: 'Select a conversation',
    ...
    community_summarize: 'Summarize',
    community_ai_summary_title: 'AI Summary:',
    community_close: 'Close',
    community_summary_fail: 'The summary could not be generated.',
    community_summary_none: 'Could not generate a summary.',
    community_summary_error: 'Error generating summary.',
    community_members: 'Members',
    community_about: 'About',
    community_message_to: 'Message to {name}...',
    community_translate: 'Translate',
    community_translation_label: 'Translation:',
    community_profile_modal_following: 'Following',
    community_profile_modal_followers: 'Followers',
    community_profile_modal_message: 'Message',
    community_profile_modal_follow: 'Follow',
    community_profile_modal_unfollow: 'Unfollow',
    community_profile_modal_no_bio: 'This user has not added a bio yet.',
    community_profile_modal_generate_bio: 'Generate Bio with AI',
