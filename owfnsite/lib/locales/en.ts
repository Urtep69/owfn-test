...
export const en = {
    ...
    // Impact Hub (Chat)
    hub_sidebar_title: `Channels`,
    hub_public_square: `Public Square`,
    hub_holders_circle: `The Holders' Circle`,
    hub_impact_council: `The Impact Council`,
    hub_guardians_sanctuary: `The Guardians' Sanctuary`,
    hub_access_denied_title: `Access Restricted`,
    hub_access_denied_holders_circle: `You must hold at least {amount} OWFN tokens to access this channel.`,
    hub_access_denied_higher_levels: `Access to this channel is granted based on demonstrated impact and community contributions. Keep engaging with the OWFN ecosystem to unlock!`,
    hub_chat_placeholder: `Type a message...`,
    hub_send: `Send`,
    hub_welcome_title: `Welcome to the Impact Hub!`,
    hub_welcome_desc: `This is the heart of the OWFN community. A place for discussion, collaboration, and real-time connection. Select a channel to begin.`,
    hub_connect_prompt_title: `Join the Conversation`,
    hub_connect_prompt_desc: `Connect your wallet to access the Impact Hub and chat with the OWFN family.`,
    hub_access_level_1: `All Members`,
    hub_access_level_2: `1M+ OWFN Holders`,
    hub_access_level_3: `Impact Contributors`,
    hub_access_level_4: `Guardians`,
};