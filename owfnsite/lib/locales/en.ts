export const en = {
    ...
    bank_transfer_available: `Bank Transfer Available`,
    direct_bank_transfer: `Direct Bank Transfer`,
    bank_transfer_verified_note: `This is a verified bank account for direct contributions.`,
    messages_of_support: `Messages of Support`,
    ...
    // Admin Presale & Panel
    admin_panel_desc: `Manage the content and settings of your platform.`,
    manage_social_cases: `Manage Social Cases`,
    manage_blog_posts: `Manage Blog Posts`,
    current_social_cases: `Current Social Cases`,
    current_blog_posts: `Current Blog Posts`,
    feature_under_development: `This feature is currently under development.`,
    create_new_post: `Create New Post`,
    
    // Blog & Comments
    blog_title: `Our Blog`,
    blog_subtitle: `Updates, stories, and insights from the Official World Family Network.`,
    read_more: `Read More`,
    author: `Author`,
    blog_no_posts: `There are no blog posts to display yet.`,
    back_to_blog: `Back to Blog`,
    blog_post_not_found: `Blog Post Not Found`,
    comments: `Comments`,
    leave_a_comment_placeholder: `Leave a supportive comment...`,
    post_comment: `Post Comment`,
    connect_to_comment: `Connect to Comment`,
    no_comments_yet: `No comments yet. Be the first to leave a message of support!`,
};