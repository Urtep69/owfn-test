export const zh = {
    ...
    faq_search_aria_label: `在常见问题中搜索`,
    faq_no_results: `未找到结果。请尝试其他搜索词或类别。`,
    faq_category_all: `全部`,
    faq_category_presale: `预售与投资`,
    faq_category_technical: `技术与代币`,
    faq_category_mission: `使命与影响`,
    faq_category_security: `安全与团队`,
    faq_q1: `什么是 OWFN？`,
    ...
    faq_q11: `预售购买代币后会发生什么？我需要做什么吗？`,
    faq_a11: `不需要，在预售期间成功购买 OWFN 代币后，您无需采取任何进一步行动。代币会自动为您的钱包地址预留。预售期结束时，所有代币将自动（通过空投）分发到购买者的钱包中。`,
    faq_q12: `预售结束后，我何时何地可以交易（买/卖）OWFN 代币？`,
    faq_a12: `根据我们的路线图，在预售成功结束后，我们将在 Solana 生态系统内的去中心化交易所（DEX）上正式上线 $OWFN 代币。确切的日期和平台将在我们的官方渠道上公布。`,
    faq_q13: `为什么预售有最大购买限制（Max Buy）？`,
    faq_a13: `最大购买限制是确保代币尽可能公平分配的重要措施，并防止少数大投资者（“鲸鱼”）控制大部分供应。这有助于促进一个更健康、更去中心化的社区。`,
    faq_q14: `代币“计息”并有 2% APY 是什么意思？它是如何运作的？`,
    faq_a14: `这意味着 OWFN 代币被编程为自动产生利息。只需将代币保存在与 Solana 兼容的钱包中，您的代币数量就会随着时间的推移而增加，年化收益率（APY）为 2%。您无需进行质押或任何额外操作；奖励会自动累积。`,
    faq_q15: `0.5% 的转账费是什么？何时激活？`,
    faq_a15: `此费用是我们使命长期资金的关键机制。预售期结束后，所有 OWFN 代币交易将收取 0.5% 的费用。从该费用中收集的资金将自动定向到影响力金库，以持续资助我们的社会项目。因此，每一笔交易都为共同利益做出贡献。`,
    faq_q16: `为什么你们选择 Solana 区块链作为这个项目的基础？`,
    faq_a16: `我们选择 Solana 是因为它卓越的速度、极低的交易成本和高可扩展性。这些特性对于我们这样的全球性项目至关重要，它能够实现高效的微交易，并确保所有用户（无论是捐赠、购买还是交易代币）都能获得快速、便捷的体验。`,
    faq_q17: `我如何能确定我的捐款能够到达你们支持的事业？`,
    faq_a17: `透明度是我们的基本原则。所有用于社会事业的资金都通过影响力金库进行管理，其钱包地址是公开的。您可以在 Solana 区块浏览器（如 Solscan）上监控所有进出交易。此外，在影响力门户上，我们将提供关于已资助项目的定期更新和详细报告。`,
    faq_q18: `我可以提议一个由 OWFN 资助的社会案例或事业吗？`,
    faq_a18: `在初始阶段，项目由我们的团队根据严格的影响力和可行性标准进行选择。随着项目的进展，我们将实施一个治理系统（DAO），允许社区成员提议并投票决定未来的倡议，让您在资金导向方面发挥直接作用。`,
    faq_q19: `OWFN 项目背后是谁？团队是匿名的吗？`,
    faq_a19: `关于我们团队的愿景和价值观的详细信息已在网站上呈现。随着我们接近公开发布，我们将提供更多关于为项目成功做出贡献的关键成员和顾问的透明信息，同时尊重他们的安全和隐私。`,
    faq_q20: `你们采取了哪些安全措施来保护项目和投资者的资金？`,
    faq_a20: `安全是我们的首要任务。我们使用多重签名钱包来管理关键资金，这意味着任何交易都不能由单一个人批准。代币的智能合约将在发布前由信誉良好的安全公司进行审计，以识别并纠正任何潜在的漏洞。`,
