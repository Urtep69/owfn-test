export const zh = {
    ...
    faq_q8: '我通过购买代币的贡献如何真正提供帮助？',
    faq_a8: `您的贡献通过两种基本方式提供帮助。首先，当您在预售期间购买代币时，大部分资金将直接进入影响力金库，以启动我们的社会项目。其次，为了创建可持续的长期资金来源，在预售期结束后，所有交易将激活0.5%的小额转账费。该费用被设计为对影响力金库的自动微型捐赠。这意味着，未来每当使用该代币时，它都会为我们的人道主义事业产生持续的支持，将整个生态系统转变为一股永久的向善力量。所有这些资金流动在区块链上都是完全透明的。`,
    ...
    chatbot_loading_1: '正在连接我的电路...',
    chatbot_loading_2: '正在分析您的问题...',
    chatbot_loading_3: '正在生成回应...',
    ...
    airdrop_warning: '警告：此工具将向所有预售贡献者批量分发 OWFN 代币。此操作不可逆。请确保预售已正式结束且所有数据正确无误。',
    total_owfn_to_distribute: '待分发的 OWFN 总额',
