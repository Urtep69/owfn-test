...
export const ro = {
    ...
    faq_a8: `Când cumpărați tokenuri OWFN, o parte semnificativă a fondurilor merge direct în Trezoreria de Impact. Această trezorerie este alocată special pentru a finanța proiectele noastre de impact social. Tehnologia blockchain asigură o transparență completă, ceea ce înseamnă că puteți verifica modul în care sunt utilizate fondurile. Achiziția dvs. nu este doar o investiție; este o contribuție directă la un fond dedicat îmbunătățirii vieților și comunităților din întreaga lume.`,
