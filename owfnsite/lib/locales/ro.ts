export const ro = {
    ...
    home_how_it_works_title: `Cum Funcționează`,
    home_how_it_works_subtitle: `Un flux simplu și transparent de la contribuție la impact.`,
    home_social_proof_title: `O Mișcare Vie, Care Respiră`,
    home_community_buzz_title: `Din Comunitatea Noastră`,
    home_partners_title: `Parteneri & Consilieri`,
    home_partners_desc: `Căutăm activ parteneriate strategice după prevânzare. Rămâneți pe fază pentru anunțuri.`,
    home_join_title: `Alătură-te Mișcării`,
    home_join_desc: `Devino parte dintr-o familie globală dedicată să facă o diferență reală. Călătoria ta începe aici.`,
