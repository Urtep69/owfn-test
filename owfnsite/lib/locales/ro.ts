export const ro = {
    ...
    profile_presale_contribution_title: `Contribuție Prevânzare`,
    profile_donation_impact_title: `Impact Donații`,
    profile_total_sol_contributed: `Total SOL Contribuit`,
    profile_owfn_to_receive: `OWFN de Primit (incl. bonus)`,
    profile_total_sol_donated: `Total SOL Donat`,
    profile_my_tx_history_title: `Istoricul Meu de Tranzacții`,
    profile_tx_type: `Tip`,
    profile_tx_amount: `Sumă`,
    profile_tx_date: `Data`,
    profile_tx_type_presale: `Contribuție Prevânzare`,
    profile_tx_type_donation: `Donație`,
    profile_scanning_history: `Se scanează istoricul tranzacțiilor...`,
    profile_no_tx_found: `Nu s-au găsit contribuții la prevânzare sau donații pentru acest portofel.`,
    profile_impact_stats_desc: `Contribuțiile dumneavoastră personale la ecosistemul OWFN. Datele sunt scanate direct de pe blockchain.`,
