export const ro = {
    ...
    profile_sign_in_prompt: `Conectați-vă portofelul și autentificați-vă pentru a vedea profilul personalizat.`,
    ...
    badge_first_donation_title: `Primul Donator`,
    badge_first_donation_desc: `Acordat pentru efectuarea primei donații.`,
    badge_community_voter_title: `Votant Comunitar`,
    badge_community_voter_desc: `Acordat pentru participarea la 5 voturi de guvernanță.`,
    badge_early_supporter_title: `Susținător Timpuriu`,
    badge_early_supporter_desc: `Acordat pentru participarea la prevânzare.`,
    badge_diverse_donor_title: `Donator Divers`,
