...
export const ro = {
    ...
    faq_q8: 'Cum ajută efectiv contribuția mea prin achiziționarea de tokeni?',
    ...
    faq_q9: 'Pe lângă cumpărarea de tokeni, cum altfel mă pot implica și pot ajuta OWFN?',
