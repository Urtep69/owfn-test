...
export const ro = {
    ...
    faq_a8: `Când cumpărați tokenuri OWFN, o parte semnificativă a fondurilor merge direct în Trezoreria de Impact pentru a finanța proiectele noastre de impact social. Mai mult, pentru a asigura finanțarea continuă a acestor cauze, o taxă mică de transfer de 0,5% va fi activată pentru toate tranzacțiile *după* finalizarea prevânzării. Această taxă acționează ca o micro-donație automată, unde 0,5% din fiecare tranzacție este direcționat către Trezoreria de Impact. Acest lucru transformă simplul act de a folosi tokenul într-o contribuție continuă la binele comun. Tehnologia blockchain asigură transparență totală pentru toate aceste fluxuri de finanțare.`,
    ...
    fully_diluted_valuation: 'Valuare Complet Diluată (FDV)',
