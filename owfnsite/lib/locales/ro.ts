export const ro = {
    ...
    airdrop_clear_progress_confirm: `Sunteți sigur că doriți să ștergeți progresul și jurnalele airdrop-ului? Această acțiune este ireversibilă și trebuie folosită doar în caz de resetare de urgență.`,
    airdrop_clear_progress: `Șterge Progresul și Jurnalele`,
    airdrop_all_processed: `Toți contributorii au fost procesați.`,
    airdrop_run_start_log: `--- Pornirea airdrop-ului pentru {count} portofele. ---`,
    airdrop_run_complete_log: `--- Rularea airdrop-ului finalizată. Succes: {success}, Eșecuri: {failed}. Total procesat: {processed}/{total} ---`,
    airdrop_batch_error_log: `❌ Eroare critică în lot (semnătura a eșuat?): {error}. Adrese eșuate: {addresses}`,
