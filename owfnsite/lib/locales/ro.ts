export const ro = {
    ...
    auth_prompt: 'Vă rugăm să semnați mesajul din portofel pentru a continua.',
    ...
    activity_tab: `Activitate`,
    profile_loading_data: `Se încarcă profilul tău Web3...`,
    profile_no_nfts: 'Nu s-au găsit NFT-uri în acest portofel.',
    profile_no_activity: 'Nicio activitate recentă.',
    portfolio_allocation: 'Alocare Portofoliu',
    coming_soon_impact_tracking: 'Funcțiile de urmărire a impactului vor fi disponibile în curând!',
    ...
    faq_a20: `Securitatea este prioritatea noastră principală. Folosim portofele cu semnături multiple pentru gestionarea fondurilor critice, ceea ce înseamnă că nicio tranzacție nu poate fi aprobată de o singură persoană. Contractul inteligent al tokenului va fi auditat de firme de securitate de renume pentru a identifica și corecta eventualele vulnerabilități înainte de lansare.`,
    chatbot_title: `Asistent OWFN`,
    chatbot_placeholder: `Pune o întrebare...`,
    chatbot_error: `Scuze, am probleme de conexiune. Te rog să încerci mai târziu.`,
    chatbot_loading_1: `Mă conectez la circuitele mele...`,
    chatbot_loading_2: `Analizez întrebarea ta...`,
    ...
    whitepaper_feature_presale: `Permite susținătorilor timpurii să cumpere tokeni OWFN înainte de lansarea publică.`,
    whitepaper_feature_donations: `Un portal dedicat pentru a face donații crypto directe către Trezoreria de Impact.`,
    ...
    whitepaper_community_desc: `Alătură-te comunității noastre în creștere și fii la curent cu cele mai recente știri:`,
    transaction_success_alert: `Tranzacție reușită! Ai trimis {amount} {tokenSymbol}.`,
    transaction_failed_alert: `Tranzacția a eșuat. Te rog să încerci din nou.`,
    translation_error_alert: `A apărut o eroare în timpul traducerii. Cazul nu a fost creat. Te rog să încerci din nou.`,
    invalid_amount_generic: `Te rog să introduci o sumă validă.`,
    vote_success_alert: `Votul tău a fost înregistrat cu succes!`,
    ...
    fully_diluted_valuation: `Evaluare Complet Diluată (FDV)`,
    market_stats: `Statistici de Piață`,
    ...
    is_mintable: `Este Mintabil?`,
    is_freezable: `Este Înghețabil?`,
    ...
    no_risk_factors_found: `Nu s-au găsit factori de risc critici, cum ar fi metadate mutabile sau autorități nerevocate.`,
    risk_factors_found: `S-au detectat riscuri potențiale. Vă rugăm să procedați cu prudență.`,
    swap: `Schimb`,
    revoked: `Revocat`,
    staking_title: `Staking OWFN, Câștigă Recompense`,
    staking_subtitle: `Blochează-ți tokenii OWFN pentru a câștiga recompense și a susține rețeaua.`,
    ...
    staking_connect_prompt: `Conectează-ți portofelul pentru a începe să faci staking cu tokenii tăi OWFN și a câștiga recompense.`,
    stake_success_alert: `Ai făcut staking cu {amount} OWFN cu succes!`,
    unstake_success_alert: `Ai retras {amount} OWFN din staking cu succes!`,
    claim_success_alert: `Ai revendicat {amount} recompense OWFN cu succes!`,
    ...
    vesting_title: `Vesting Tokeni`,
    vesting_subtitle: `Urmărește-ți programele de vesting și revendică tokenii deblocați.`,
    ...
    claim_tokens: `Revendică Tokeni`,
    vesting_claim_success: `Ai revendicat {amount} tokeni OWFN cu succes!`,
    ...
    vesting_schedule_created: `Programul de vesting a fost creat cu succes!`,
    all_vesting_schedules: `Toate Programele de Vesting`,
    airdrop_title: `Airdrop Tokeni OWFN`,
    ...
    airdrop_eligible_message: `Portofelul tău este eligibil! Vei primi {amount} tokeni OWFN în următoarea distribuție.`,
    ...
    no_past_proposals: `Nu există propuneri trecute de afișat.`,
    ...
    maintenance_login_denied: `Conexiune refuzată. Platforma este în modul de mentenanță. Doar administratorii se pot conecta.`,
    coming_soon_title: `În Curând`,
    coming_soon_desc: `Această funcționalitate este în prezent în dezvoltare. Lucrăm din greu pentru a v-o oferi în curând. Vă mulțumim pentru răbdare și sprijin.`,
    ...
    airdrop_warning: `AVERTISMENT: Acest instrument va iniția distribuția în masă a tokenilor OWFN către toți contribuitorii la prevânzare. Această acțiune este ireversibilă. Asigurați-vă că prevânzarea s-a încheiat oficial și că toate datele sunt corecte.`,
    ...
    airdrop_confirmation_prompt: `Ești sigur că vrei să pornești airdrop-ul? Aceasta va trimite tokeni OWFN către {count} portofele unice și nu poate fi anulat.`,
    ...
    contact_subtitle: `Ne-ar plăcea să auzim de la tine. Alege mai jos cea mai bună modalitate de a ne contacta.`,
    ...
    contact_reason_press: `Solicitare Presă`,
    contact_reason_support: `Suport Tehnic`,
    contact_reason_feedback: `Feedback și Sugestii`,
    contact_reason_other: `Altceva`,
    contact_send_message: `Trimite Mesaj`,
    ...
    contact_error_message: `A apărut o eroare. Te rog să încerci din nou mai târziu.`,
    contact_faq_title: `Ai o întrebare rapidă?`,
    contact_faq_desc: `Multe răspunsuri pot fi găsite deja în secțiunea noastră de Întrebări Frecvente. Economisește timp și verifică acum!`,
    ...
    contact_disclaimer_message: `Pentru a ne asigura că echipa noastră poate sprijini eficient comunitatea și poate avansa proiectul, acordăm prioritate solicitărilor direct legate de Official World Family Network. Mesajele care nu sunt la subiect, spam-ul sau solicitările nesolicitate s-ar putea să nu primească un răspuns. Vă mulțumim pentru înțelegere și pentru că ne ajutați să ne concentrăm pe misiunea noastră.`,
    ...
    contact_social_discord_desc: `Fii parte din comunitatea noastră activă pentru discuții și suport.`,
};