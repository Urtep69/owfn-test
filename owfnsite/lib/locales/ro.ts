...
export const ro = {
    ...
    community_toolkit_share_x_aria: `Distribuie pe X`,
    community_toolkit_share_telegram_aria: `Distribuie pe Telegram`,
    community_toolkit_share_facebook_aria: `Distribuie pe Facebook`,
    ...
    faq_q12: 'Când și unde voi putea tranzacționa (vinde/cumpăra) tokeni OWFN după prevânzare?',
    ...
    faq_q17: 'Pot propune un caz social sau o cauză care să fie finanțată de OWFN?',
    ...
    faq_a18: 'Detaliile despre viziunea și valorile echipei noastre sunt prezentate pe site. Pe măsură ce ne apropiem de lansarea publică, vom oferi mai multă transparență cu privire la membrii cheie și consilierii care contribuie la succesul proiectului, respectând în același timp siguranța și confidențialitatea acestora.',
    faq_q19: 'Ce măsuri de securitate ați luat pentru a proteja fondurile proiectului și ale investitorilor?',
    faq_a19: 'Securitatea este prioritatea noastră principală. Folosim portofele cu semnături multiple pentru gestionarea fondurilor critice, ceea ce înseamnă că nicio tranzacție nu poate fi aprobată de o singură persoană. Contractul inteligent al tokenului va fi auditat de firme de securitate de renume pentru a identifica și corecta orice vulnerabilități potențiale înainte de lansare.',
    ...
    whitepaper_features_title: `Ecosistem și Caracteristici ale Proiectului`,
    whitepaper_features_desc: `Platforma OWFN oferă mai multe funcționalități cheie pentru a-și susține misiunea:`,
    whitepaper_feature_presale: `Permite susținătorilor timpurii să cumpere tokenuri OWFN înainte de lansarea publică.`,
    whitepaper_feature_donations: `Un portal dedicat pentru efectuarea de donații crypto direct către Trezoreria de Impact.`,
    whitepaper_feature_dashboard: `Oferă monitorizare în timp real a tuturor portofelelor oficiale ale proiectului pentru transparență completă.`,
    whitepaper_feature_impact_portal: `Prezintă cazuri sociale specifice finanțate de proiect, permițând comunității să vadă impactul lor.`,
    whitepaper_community_title: `Comunitate și Linkuri Oficiale`,
    whitepaper_community_desc: `Alăturați-vă comunității noastre în creștere și fiți la curent cu cele mai recente știri:`,

    // Alerts & Messages
    transaction_success_alert: `Tranzacție reușită! Ați trimis {amount} {tokenSymbol}.`,
    transaction_failed_alert: `Tranzacția a eșuat. Vă rugăm să încercați din nou.`,
    ...
    holders: `Deținători`,
    trading_stats: `Statistici de Tranzacționare`,
    buys: `Cumpărări`,
    sells: `Vânzări`,
    ...
    contact_subtitle: `Ne-ar plăcea să auzim de la tine. Alege cea mai bună modalitate de a ne contacta mai jos.`,
    contact_how_can_we_help: `Cum te putem ajuta?`,
    contact_general_inquiries: `Întrebări Generale`,
    contact_general_desc: `Pentru orice întrebări generale despre proiect.`,
    ...
    contact_press_desc: `Pentru jurnaliști, bloggeri și cereri media.`,
    contact_technical_support: `Suport Tehnic`,
    contact_support_desc: `Pentru probleme tehnice cu site-ul, prevânzarea sau portofelul.`,
    contact_socials_title: `Alătură-te Conversației`,
    contact_form_title: `Trimite-ne un Mesaj Direct`,
    contact_form_name: `Numele Tău`,
    contact_form_email: `Adresa Ta de Email`,
    ...
    contact_reason_press: `Cerere de Presă`,
    contact_reason_support: `Suport Tehnic`,
    contact_reason_feedback: `Feedback și Sugestii`,
    contact_reason_other: `Altul`,
    contact_send_message: `Trimite Mesajul`,
    contact_sending: `Se trimite...`,
    contact_success_title: `Mulțumim!`,
    contact_success_message: `Mesajul tău a fost trimis. Te vom contacta în curând.`,
    contact_error_message: `A apărut o eroare. Te rugăm să încerci din nou mai târziu.`,
    contact_faq_title: `Ai o întrebare rapidă?`,
    contact_faq_desc: `Multe răspunsuri se găsesc deja în secțiunea noastră de Întrebări Frecvente. Economisește timp și verifică acum!`,
    contact_faq_button: `Vezi Întrebările Frecvente`,
    contact_required_fields: `Câmpurile marcate cu un asterisc (*) sunt obligatorii.`,
    contact_disclaimer_title: `Notă despre Politica Noastră de Comunicare`,
    contact_disclaimer_message: `Pentru a ne asigura că echipa noastră poate sprijini eficient comunitatea și avansa proiectul, prioritizăm cererile direct legate de Official World Family Network. Mesajele care nu sunt la subiect, spamul sau solicitările nesolicitate s-ar putea să nu primească un răspuns. Îți mulțumim pentru înțelegere și pentru că ne ajuți să ne concentrăm pe misiunea noastră.`,
    ...
    contact_social_discord_desc: `Fă parte din comunitatea noastră activă pentru discuții și suport.`,
    send_direct_message: 'Trimite Mesaj Direct',

    // AI Features
    ai_summary_button: `Obține Rezumat AI`,
    ...
    nft_reward_loading: `Se generează opera ta de artă unică... Acest lucru poate dura un moment.`,
    nft_reward_significant_donation_prompt: `Donează ${'$'}{threshold}+ pentru a genera artă de mulțumire unică!`,
    api_error_generic: `Cererea nu a putut fi finalizată în acest moment.`,
    ...
    airdrop_warning: `AVERTISMENT: Acest instrument va iniția distribuția în masă a tokenurilor OWFN către toți contributorii prevânzării. Această acțiune este ireversibilă. Asigură-te că prevânzarea s-a încheiat oficial și că toate datele sunt corecte.`,
    total_owfn_to_distribute: `Total OWFN de Distribuit`,
    your_owfn_balance: `Soldul Tău de OWFN`,
    insufficient_owfn_balance: `Sold de OWFN insuficient pentru a efectua airdrop-ul.`,
    your_sol_balance: `Soldul Tău de SOL (pentru taxe)`,
    insufficient_sol_balance: `Sold de SOL insuficient pentru taxele de tranzacție.`,
    ...
    airdrop_clear_progress_confirm: `Ești sigur că vrei să ștergi progresul și jurnalele airdrop-ului? Această acțiune nu poate fi anulată și este destinată doar resetărilor de urgență.`,
    airdrop_all_processed: `Toți contributorii au fost procesați.`,
    airdrop_run_start_log: `--- Se pornește runda de airdrop pentru {count} portofele. ---`,
    airdrop_run_complete_log: `--- Runda de airdrop finalizată. Succes: {success}, Eșec: {failed}. Total procesat: {processed}/{total} ---`,
    airdrop_batch_error_log: `❌ Eroare critică în lot (semnătură eșuată?): {error}. Adrese eșuate: {addresses}`,
    ...
    stake_success_alert: `Ai făcut staking cu succes pentru {amount} OWFN!`,
    unstake_success_alert: `Ai retras cu succes din staking {amount} OWFN!`,
    claim_success_alert: `Ai revendicat cu succes {amount} recompense OWFN!`,
    impact_staking_title: `Staking de Impact`,
    impact_staking_desc: `Contribuie cu o parte din recompensele tale de staking la cauze de impact social.`,
    donate_rewards_percentage: `Vei dona {percentage}% din recompensele revendicate către Trezoreria de Impact.`,

    // Vesting
    vesting_title: `Vesting de Tokenuri`,
    vesting_subtitle: `Urmărește-ți programele de vesting și revendică-ți tokenurile deblocate.`,
    ...
    no_vesting_schedule_desc: `Nu există niciun program de vesting asociat cu adresa portofelului conectat.`,
    ...
    cliff_period: `Sfârșitul Perioadei de Cliff`,
    claimable_now: `Revendicabil Acum`,
    claim_tokens: `Revendică Tokenuri`,
    vesting_claim_success: `Ai revendicat cu succes {amount} tokenuri OWFN vestite!`,
    ...
    vesting_duration_months: `Durata Vesting-ului (în luni)`,
    cliff_period_months: `Perioada de Cliff (în luni)`,
    ...
    // Airdrop
    airdrop_title: `Airdrop de Tokenuri OWFN`,
    ...
    ended: `Încheiat`,
    wallet_modal_easy_connect: `Conectare Ușoară (Recomandat)`,
