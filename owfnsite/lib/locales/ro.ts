export const ro = {
    ...
    bank_transfer_available: `Transfer Bancar Disponibil`,
    direct_bank_transfer: `Transfer Bancar Direct`,
    bank_transfer_verified_note: `Acesta este un cont bancar verificat pentru contribuții directe.`,
    messages_of_support: `Mesaje de Susținere`,
    ...
    // Admin Presale & Panel
    admin_panel_desc: `Gestionează conținutul și setările platformei tale.`,
    manage_social_cases: `Gestionare Cazuri Sociale`,
    manage_blog_posts: `Gestionare Articole Blog`,
    current_social_cases: `Cazuri Sociale Curente`,
    current_blog_posts: `Articole de Blog Curente`,
    feature_under_development: `Funcționalitate în curs de dezvoltare.`,
    create_new_post: `Creează Articol Nou`,

    // Blog & Comments
    blog_title: `Blogul Nostru`,
    blog_subtitle: `Actualizări, povești și perspective de la Official World Family Network.`,
    read_more: `Citește mai mult`,
    author: `Autor`,
    blog_no_posts: `Nu există încă articole de blog de afișat.`,
    back_to_blog: `Înapoi la Blog`,
    blog_post_not_found: `Articol de Blog Negăsit`,
    comments: `Comentarii`,
    leave_a_comment_placeholder: `Lasă un comentariu de susținere...`,
    post_comment: `Postează Comentariul`,
    connect_to_comment: `Conectează-te pentru a comenta`,
    no_comments_yet: `Niciun comentariu încă. Fii primul care lasă un mesaj de susținere!`,
};