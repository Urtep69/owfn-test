export const ro = {
    ...
    presale_min_amount_error: `Suma minimă de cumpărare este {min} SOL. Valoarea va fi ajustată automat.`,
    presale_max_amount_error: `Contribuția totală nu poate depăși {max} SOL. Mai puteți cumpăra {remaining}. Valoarea va fi ajustată automat.`,
