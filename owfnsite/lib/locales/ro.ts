export const ro = {
    ...
    faq_a14: `OWFN este un Token Purtător de Dobândă (IBT) care își recompensează automat deținătorii cu un Randament Procentual Anual (APY) de 2%. Acest lucru înseamnă că deținerile dvs. de OWFN vor crește în timp doar prin păstrarea lor în portofelul Solana.`,
    faq_q15: `Ce este taxa de transfer de 0.5% și când se aplică?`,
    ...
    presale_you_contributed_modal: "Ați contribuit cu:",
    presale_you_will_receive_modal: "Veți primi aproximativ:",
    presale_airdrop_info_modal: "Tokenurile sunt rezervate și vor fi distribuite la finalul prevânzării.",
    presale_welcome_family_modal: "Felicitări și bun venit în familia OWFN!",
    donation_success_title: "Donație Reușită!",
    donation_success_message_modal: "Vă mulțumim pentru donația generoasă de {amount} {tokenSymbol} către Trezoreria de Impact.",
    donation_success_message_case_modal: "Vă mulțumim pentru donația generoasă de {amount} {tokenSymbol} pentru cazul: {title}.",
    donation_thank_you_family_modal: "Sprijinul dumneavoastră este fundația schimbării. Bun venit în familia OWFN!",
    ...
    // Airdrop Public Page
    airdrop_tasks_incomplete_title: 'Sarcini Incomplete',
    airdrop_tasks_incomplete_desc: 'Vă rugăm să finalizați toate sarcinile pentru a vă înregistra la airdrop.',
    airdrop_register_button: 'Înregistrează-te pentru Airdrop',
    airdrop_success_title: 'Înregistrare Reușită!',
    airdrop_success_desc: 'Ați fost înregistrat cu succes pentru airdrop. Recompensele vor fi distribuite după verificare.',
    airdrop_registered_title: 'Deja Înregistrat',
    airdrop_registered_desc: 'Această adresă de portofel a fost deja înregistrată pentru airdrop.',
    airdrop_error_title: 'Eroare la Înregistrare',
    airdrop_error_desc: 'A apărut o eroare la procesarea înregistrării. Vă rugăm să încercați din nou mai târziu.',
    airdrop_page_subtitle: 'Finalizați sarcinile de mai jos și înregistrați-vă portofelul SOL pentru a fi eligibil pentru recompensele viitoare ale airdrop-ului.',
    airdrop_join_title: 'Alăturați-vă Airdrop-ului Nostru',
    airdrop_join_desc: 'Efectuați următoarele sarcini pentru a vă califica pentru airdrop.',
    airdrop_task_follow_x: 'Urmăriți pe X',
    airdrop_task_join_telegram: 'Alăturați-vă pe Telegram',
    airdrop_task_join_discord: 'Alăturați-vă pe Discord',
    airdrop_task_retweet: 'Retweetați Tweet-ul Ancorat',
    airdrop_rules_title: 'Reguli și Condiții Airdrop',
    airdrop_rule_1: 'Este necesară o adresă de portofel SOL validă.',
    airdrop_rule_2: 'Înregistrările multiple și cele cu boți sunt interzise; se vor efectua verificări.',
    airdrop_rule_3: 'Distribuția airdrop-ului va avea loc după încheierea evenimentului și verificarea sarcinilor.',
    airdrop_rule_4: 'OWFN își rezervă dreptul de a modifica regulile sau de a anula evenimentul în orice moment.',
};