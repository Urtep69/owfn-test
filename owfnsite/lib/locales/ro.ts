export const ro = {
    ...
    badge_first_donation_desc: `Acordat pentru efectuarea primei donații către cauză.`,
    badge_community_voter_title: `Votant Comunitar`,
    badge_community_voter_desc: `Acordat pentru participarea la un vot de guvernanță.`,
    badge_diverse_donor_title: `Susținător Diversificat`,
    badge_diverse_donor_desc: `Acordat pentru donarea a mai multor tipuri de active cripto.`,
    badge_presale_pioneer_title: `Pionier al Prevânzării`,
    badge_presale_pioneer_desc: `Acordat pentru participarea la prevânzarea tokenului OWFN.`,
    impact_portfolio_chart_title: `Distribuția Portofoliului`,
    portfolio_chart_other_category: `Altele`,
