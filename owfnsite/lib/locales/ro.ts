...
export const ro = {
    ...
    airdrop_clear_progress: `Șterge Progres și Jurnale`,
    airdrop_clear_progress_confirm: `Sunteți sigur că doriți să ștergeți progresul și jurnalele airdrop-ului? Această acțiune nu poate fi anulată și este destinată doar resetărilor de urgență.`,
    ...
    airdrop_run_complete_log: `--- Rularea airdrop-ului finalizată. Reușite: {success}, Eșuate: {failed}. Total procesate: {processed}/{total} ---`,
    airdrop_batch_error_log: `❌ Eroare critică în lot (semnarea a eșuat?): {error}. Adrese eșuate: {addresses}`,
    airdrop_success_log: `✅ Succes pentru {address}... | Semnătură: {signature}...`,
    ...
    staking_subtitle: `Blochează-ți tokenurile OWFN pentru a câștiga recompense și a sprijini rețeaua.`,
    total_staked: `Total Staking`,
    estimated_apy: `APY Estimat`,
    my_staked_balance: `Balanța Mea în Staking`,
    stake: `Stake`,
    unstake: `Unstake`,
    stake_owfn: `Pune în Staking OWFN`,
    unstake_owfn: `Retrage din Staking OWFN`,
    my_rewards: `Recompensele Mele`,
    claim_rewards: `Revendică Recompense`,
    staking_connect_title: `Conectează-te pentru Staking`,
    staking_connect_prompt: `Conectează-ți portofelul pentru a începe să pui în staking tokenurile OWFN și a câștiga recompense.`,
    stake_success_alert: `Ai pus în staking {amount} OWFN cu succes!`,
    unstake_success_alert: `Ai retras din staking {amount} OWFN cu succes!`,
    claim_success_alert: `Ai revendicat {amount} recompense OWFN cu succes!`,
    impact_staking_title: `Staking cu Impact`,
    impact_staking_desc: `Contribuie cu o parte din recompensele tale de staking la cauze cu impact social.`,
    ...
    total_amount_owfn: `Suma Totală (OWFN)`,
    ...
    // Airdrop
    airdrop_title: `Airdrop Tokenuri OWFN`,
    ...
    governance_subtitle: `Participă la viitorul OWFN votând propunerile.`,
