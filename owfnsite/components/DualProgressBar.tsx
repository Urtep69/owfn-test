...
export const DualProgressBar: React.FC<DualProgressBarProps> = ({
  ...
  return (
    <div className="w-full my-2">
      <div className="flex justify-between items-center mb-1 text-sm font-bold text-foreground">
        <span className="text-green-400">{label1}</span>
        <span className="text-red-400">{label2}</span>
      </div>
      ...
      <div className="flex justify-between items-center mt-1 text-base font-semibold text-foreground font-mono">
