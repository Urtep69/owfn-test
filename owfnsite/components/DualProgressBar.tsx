...
export const DualProgressBar: React.FC<DualProgressBarProps> = ({
  ...
  return (
    <div className="w-full my-2">
      <div className="flex justify-between items-center mb-1 text-sm font-bold text-slate-800 dark:text-slate-200">
      ...
      <div className="flex justify-between items-center mt-1 text-base font-semibold text-slate-900 dark:text-slate-100 font-mono">
