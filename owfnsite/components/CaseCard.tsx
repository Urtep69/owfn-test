...
export const CaseCard = ({ socialCase }: { socialCase: SocialCase }) => {
    ...
    return (
        <div className="bg-surface border border-border rounded-lg overflow-hidden flex flex-col transition-transform hover:-translate-y-1">
            ...
            <div className="p-6 flex-grow flex flex-col">
                ...
                <Link to={`/impact/case/${socialCase.id}`} className="mt-auto block w-full text-center bg-primary text-white font-bold py-2 rounded-lg hover:bg-opacity-80 transition-colors">
                    {t('view_case')}
                </Link>
            </div>
        </div>
