...
const CustomTooltip = ({ active, payload }: any) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-primary-100/80 dark:bg-darkPrimary-800/80 backdrop-blur-md p-3 border-2 border-primary-900 dark:border-primary-200 rounded-lg shadow-neo-brutal dark:shadow-dark-neo-brutal text-primary-900 dark:text-primary-100">
