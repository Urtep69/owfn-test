...
export default async function handler(req: any, res: any) {
    try {
        ...
        const systemInstructionParts = [
            ...
            '',
            '**4. Presale & Trading**',
            '- **Presale Dates:** The presale starts on October 15, 2025 and ends on November 15, 2025.',
            '- **Presale Rate:** 1 SOL = 10,000,000 OWFN (before bonuses).',
            ...
            '- **Tiered Bonuses:** Bonuses are offered based on the contribution amount in a single transaction:',
            '  - 0.5 - 1.99 SOL: 10% bonus on OWFN tokens.',
            '  - 2 - 3.99 SOL: 20% bonus on OWFN tokens.',
            '  - 4 - 5 SOL: 30% bonus on OWFN tokens.',
