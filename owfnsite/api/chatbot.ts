...
- **Contribution Limits:** The minimum purchase amount is 0.1 SOL (Min Buy: 0.1 SOL). The maximum purchase amount is 5 SOL per wallet (Max Buy: 5 SOL). This limit ensures fair distribution.
