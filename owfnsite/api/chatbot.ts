...
// Only import the English translation file to build the knowledge base.
// This dramatically reduces the memory footprint of the serverless function, preventing 500 errors.
// The AI will be instructed to respond in the user's selected language based on this English context.
...
// This function generates the knowledge base for the AI using only English content.
const generateKnowledgeBase = (langCode: string): string => {
  const t = en; // Always use English for the knowledge base context.
