...
export default async function handler(req: any, res: any) {
    try {
        ...
        const systemInstructionParts = [
            ...
            '- **CRITICAL INSTRUCTION**: Always use this current time to determine the status of events. For example, if the current date is between the presale start and end dates, you must state that the presale is currently active. If it\'s before the start date, state it is upcoming. If it\'s after the end date, state it has concluded.',
            '',
            ...
            '',
            '**2. Presale & Trading**',
            '- **Public Presale Period:** September 20, 2025 to October 20, 2025.',
            '- **Exact Start Time:** The presale begins precisely at 00:00:00 UTC on September 20, 2025 (the moment the night of September 19 ends).',
            '- **Exact End Time:** The presale concludes precisely at 00:00:00 UTC on October 21, 2025 (the moment the night of October 20 ends). This ensures the entire day of October 20 is available for participation.',
