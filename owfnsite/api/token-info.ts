...
import { MOCK_TOKEN_INFO_API } from '../lib/api-constants.ts';
...
export default async function handler(req: any, res: any) {
    ...
    try {
        ...
        const mockDetailsKey = Object.keys(MOCK_TOKEN_INFO_API).find(key => MOCK_TOKEN_INFO_API[key].mintAddress === mintAddress);
        if (mockDetailsKey) {
            const mock = MOCK_TOKEN_INFO_API[mockDetailsKey];
