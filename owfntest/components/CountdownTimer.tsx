...
const TimeUnit = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center justify-center bg-primary-700/50 rounded-lg p-4 w-24 h-24 shadow-inner-3d">
        <span className="text-4xl font-bold text-accent-400">{String(value).padStart(2, '0')}</span>
        <span className="text-sm uppercase text-primary-400">{label}</span>
    </div>
);
