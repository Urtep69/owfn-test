...
const FaqItem = ({ q, a, isOpen, onClick }: { q: string, a: string, isOpen: boolean, onClick: () => void }) => {
    return (
        <div className="border-b border-primary-700 py-4">
            <button
                onClick={onClick}
                className="w-full flex justify-between items-center text-left text-lg font-semibold text-primary-200"
            >
                <span>{q}</span>
            ...
            >
                <p className="text-primary-400 leading-relaxed pt-2">
                    {a}
                </p>
            </div>
        </div>
    ...
    return (
        <div className="animate-fade-in-up max-w-4xl mx-auto">
            <div className="text-center mb-12">
                ...
                <h1 className="text-4xl font-bold text-accent-400">{t('faq_title')}</h1>
