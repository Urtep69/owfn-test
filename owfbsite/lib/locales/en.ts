...
export const en = {
    ...
    project_reliability_score: 'Project reliability score based on:',
    audit_title: 'Audit',
    verify_external_audits: 'Verify external audits',
    contract_verified: 'Contract Verified',
    honeypot: 'Honeypot',
    freezable: 'Freezable',
    mintable: 'Mintable',
    check_audits: 'Check Audits (Alerts: {count})',
    community_trust_title: 'Community Trust',
    of_trades: 'of {total} trades',
